import { getDokkanFyiSupportMemoryDetails, writeDokkanFyiSupportMemoryDetails } from "./fyi-support-memory-details";

void (async function run() {
    const dataset = await getDokkanFyiSupportMemoryDetails();
    const outputPath = await writeDokkanFyiSupportMemoryDetails(dataset);
