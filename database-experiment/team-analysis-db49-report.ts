import { DatabaseTeamAnalysisDb49Coverage } from "./team-analysis-db49-contract";
export function renderDatabaseTeamAnalysisDb49Report(coverage:DatabaseTeamAnalysisDb49Coverage):string{return `# DB49 — Forced guard native semantics
