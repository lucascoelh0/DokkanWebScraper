...
export async function runDatabaseExperiment(options: RunOptions): Promise<{
    ...
    const nativeLinkageEvidencePath = resolve(__dirname, "..", "..", "database-experiment", "native-passive-turn-linkage-audit.json"); const nativeLinkageEvidenceBytes = await readFile(nativeLinkageEvidencePath); const nativeLinkageEvidence = JSON.parse(nativeLinkageEvidenceBytes.toString("utf8")) as Db21NativeLinkageEvidence; const nativeLinkageEvidenceSha256 = sha256(nativeLinkageEvidenceBytes);
    ...
    const counterEvidencePath = resolve(__dirname, "..", "..", "database-experiment", "native-counter-behavior-semantics.json"); const counterEvidenceBytes = await readFile(counterEvidencePath); const counterEvidence = JSON.parse(counterEvidenceBytes.toString("utf8")) as Db24NativeCounterEvidence; const counterEvidenceSha256 = sha256(counterEvidenceBytes);
    ...
    const targetHpEvidencePath = resolve(__dirname, "..", "..", "database-experiment", "native-target-hp-semantics.json"); const targetHpEvidenceBytes = await readFile(targetHpEvidencePath); const targetHpEvidence = JSON.parse(targetHpEvidenceBytes.toString("utf8")) as Db27NativeTargetHpEvidence; const targetHpEvidenceSha256 = sha256(targetHpEvidenceBytes);
    ...
    const revivalCounterEvidencePath = resolve(__dirname, "..", "..", "database-experiment", "native-revival-counter-semantics.json"); const revivalCounterEvidenceBytes = await readFile(revivalCounterEvidencePath); const revivalCounterEvidence = JSON.parse(revivalCounterEvidenceBytes.toString("utf8")) as Db28NativeRevivalEvidence; const revivalCounterEvidenceSha256 = sha256(revivalCounterEvidenceBytes);
    ...
    const attackBreakEvidencePath = resolve(__dirname, "..", "..", "database-experiment", "native-attack-break-semantics.json"); const attackBreakEvidenceBytes = await readFile(attackBreakEvidencePath); const attackBreakEvidence = JSON.parse(attackBreakEvidenceBytes.toString("utf8")) as Db29NativeAttackBreakEvidence; const attackBreakEvidenceSha256 = sha256(attackBreakEvidenceBytes);
    ...
    const removalEvidencePath = resolve(__dirname, "..", "..", "database-experiment", "native-efficacy-removal-semantics.json"); const removalEvidenceBytes = await readFile(removalEvidencePath); const removalEvidence = JSON.parse(removalEvidenceBytes.toString("utf8")) as Db30NativeRemovalEvidence; const removalEvidenceSha256 = sha256(removalEvidenceBytes);
