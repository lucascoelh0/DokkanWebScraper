import { DatabaseTeamAnalysisDb28Coverage } from "./team-analysis-db28-contract";

export function renderDatabaseTeamAnalysisDb28Report(coverage: DatabaseTeamAnalysisDb28Coverage): string {
