import{DatabaseTeamAnalysisDb32Coverage}from"./team-analysis-db32-contract";
export function renderDatabaseTeamAnalysisDb32Report(c:DatabaseTeamAnalysisDb32Coverage){const rows=Object.entries(c.rawTimingCounts).map(([k,v])=>`| ${k} | ${v} |`).join("\n");return`# Database Team Analysis experiment — DB32 execution timing
