import { DatabaseTeamAnalysisDb48Coverage } from "./team-analysis-db48-contract";
export const renderDatabaseTeamAnalysisDb48Report=(c:DatabaseTeamAnalysisDb48Coverage)=>`# DB48 efficacy 13 damage mitigation
