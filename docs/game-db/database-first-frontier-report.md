...
Status: experimental, non-production. Updated through DB42 (`0.41.0`) against snapshot `global-6.4.0-v338-2026-08-05`.
...
- the semantic identity, population/reset window and consumer-gate product meaning for raw obtained-ball map key 11 before efficacy-61 can be simulated without externally supplied count state;
