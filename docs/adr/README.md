...
| [0008](0008-use-only-first-party-support-memory-content.md) | Use only first-party Support Memory content | superseded in part by 0009 | 2026-08-31 |
| [0009](0009-use-authorized-support-memory-acquisition-presentation.md) | Use authorized Support Memory acquisition presentation | accepted | 2026-09-02 |
