...
exports.buildAcquisitionDataset = exports.writeDokkanFyiAcquisitionDataset = exports.getDokkanFyiAcquisitionDataset = void 0;
    ...
    for (const mission of category.missions) {
        for (const reward of mission.rewards) {
            ...
            upsertSource(itemsByKey, createItemIdentity(reward.itemType, reward.itemId, reward), {
                ...
                stageReferences: resolveMissionStageReferences(category.id, mission.id, dokkanInfoMissionStageIdsByKey, dokkanInfoStageById),
            });
        }
    }
}
...
function resolveMissionStageReferences(categoryId, missionId, missionStageIdsByKey, stagesById) {
