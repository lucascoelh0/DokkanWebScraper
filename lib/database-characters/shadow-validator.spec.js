...
describe("database character K13 fallback safety", () => {
    ...
    it("rejects a payload-defined authority matrix and keeps external fields unchanged", () => {
        ...
        (0, assert_1.equal)(result.applied, false);
        (0, assert_1.equal)(result.reason, "audit_only");
        (0, assert_1.deepStrictEqual)(result.characters, source);
        (0, assert_1.ok)((0, shadow_validator_1.validateCharacterShadowProjection)(forged).failures.includes("non-canonical authority matrix"));
    });
    ...
    it("rejects a present K11 object without inspecting it", () => {
        ...
        const result = (0, shadow_validator_1.applyOptionalCharacterShadowInMemory)(source, guarded);
        (0, assert_1.equal)(result.applied, false);
        (0, assert_1.equal)(result.reason, "audit_only");
        (0, assert_1.deepStrictEqual)(result.characters, source);
    });
