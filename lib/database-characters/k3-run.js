...
async function run() {
    ...
    try {
        ...
        const [c1Path, c2Path] = await Promise.all([
            (0, artifact_path_1.resolveCharacterInputFile)(integrationDir, C1.fileName, C1.fileName),
            (0, artifact_path_1.resolveCharacterInputFile)(integrationDir, C2.fileName, C2.fileName),
        ]);
        const c1 = await (0, source_1.readPinnedGzipJson)(c1Path, C1);
        const c2 = await (0, source_1.readPinnedGzipJson)(c2Path, C2);
