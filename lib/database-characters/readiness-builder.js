...
exports.buildDatabaseCharacterReadinessCoverage = exports.buildDatabaseCharacterReadinessDataset = void 0;
...
function buildDatabaseCharacterReadinessDataset() {
    const sidecars = refresh_contract_1.CHARACTER_REFRESH_PROFILE.sidecars.map(sidecar => ({ gate: sidecar.gate, sha256: sidecar.artifact.sha256, sizeBytes: sidecar.artifact.sizeBytes, uncompressedSizeBytes: sidecar.artifact.uncompressedSizeBytes, consumerEligible: sidecar.consumerScopes.length > 0 }));
    return {
        schemaVersion: 1,
        contract: "dokkan-database-character-readiness",
        contractVersion: "1.0.0",
        generatedAt: refresh_contract_1.CHARACTER_REFRESH_PROFILE.generatedAt,
        source: { k8ReceiptSha256: K8.receiptSha256, k8ManifestSha256: K8.manifestSha256, profileId: refresh_contract_1.CHARACTER_REFRESH_PROFILE.profileId, snapshotVersion: refresh_contract_1.CHARACTER_REFRESH_PROFILE.snapshotVersion },
...
exports.buildDatabaseCharacterReadinessDataset = buildDatabaseCharacterReadinessDataset;
function buildDatabaseCharacterReadinessCoverage(dataset) {
...
exports.buildDatabaseCharacterReadinessCoverage = buildDatabaseCharacterReadinessCoverage;
//# sourceMappingURL=readiness-builder.js.map