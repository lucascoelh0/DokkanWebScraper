...
async function runCharacterLeaderK55Subprocess(options) {
    ...
    const child = (0, child_process_1.spawn)(process.execPath, executableArgs, { shell: false, windowsHide: true, stdio: ["ignore", "pipe", "pipe"] });
