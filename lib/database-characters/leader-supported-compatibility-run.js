...
async function main() {
    ...
    let loaded = await (0, leader_supported_compatibility_source_1.loadCharacterLeaderSupportedCompatibilityInputs)(options);
    const first = (0, leader_supported_compatibility_1.materializeCharacterLeaderSupportedCompatibility)((0, leader_supported_compatibility_1.buildCharacterLeaderSupportedCompatibilityReport)(loaded.inputs));
    const second = (0, leader_supported_compatibility_1.materializeCharacterLeaderSupportedCompatibility)((0, leader_supported_compatibility_1.buildCharacterLeaderSupportedCompatibilityReport)(loaded.inputs));
    ...
    await (0, leader_supported_compatibility_source_1.writeCharacterLeaderSupportedCompatibilityArtifacts)(options.outputRoot, first);
    const initialChildPeak = loaded.k55ValidationProcessPeakRssBytes;
    loaded = undefined;
    global.gc();
    const validated = await (0, leader_supported_compatibility_source_1.validateCharacterLeaderSupportedCompatibilityArtifact)(options);
