...
exports.buildDatabaseCharacterRefreshCoverage = exports.buildDatabaseCharacterRefreshReceipt = void 0;
const refresh_contract_1 = require("./refresh-contract");
function buildDatabaseCharacterRefreshReceipt() {
    const profile = refresh_contract_1.CHARACTER_REFRESH_PROFILE;
    const sidecars = profile.sidecars.map(sidecar => ({
        ...sidecar,
        schemaVersion: 1,
        sourceDb1ArtifactSha256: profile.db1.sha256,
        validationValid: true,
        absenceBehavior: "preserve_production",
    }));
    return {
        schemaVersion: 1,
...
exports.buildDatabaseCharacterRefreshReceipt = buildDatabaseCharacterRefreshReceipt;
function buildDatabaseCharacterRefreshCoverage(receipt) {
    return {
        schemaVersion: 1,
...
exports.buildDatabaseCharacterRefreshCoverage = buildDatabaseCharacterRefreshCoverage;
//# sourceMappingURL=refresh-builder.js.map