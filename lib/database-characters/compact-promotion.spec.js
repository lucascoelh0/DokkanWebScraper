...
const compactOverlay = require("./compact-overlay");
...
describe("database character K17 compact in-memory promotion overlay", () => {
    ...
    it("globally suppresses a valid candidate when any blocker exists", () => {
        ...
        const overlay = (0, compact_overlay_1.createCharacterCompactRarityOverlay)(characters, compact);
        (0, assert_1.equal)(overlay.decision.candidates.count, 1);
        (0, assert_1.equal)(overlay.decision.overlayProof.candidatesAppliedToClone, 0);
        (0, assert_1.deepStrictEqual)(overlay.characters, characters);
    });
    ...
    it("matches K16 precedence and first-path selection", async () => {
        ...
        (0, assert_1.equal)(oldIndex.selected.get("1").sourceRecordPath, "$[0]");
        (0, assert_1.equal)(oldIndex.selected.get("2").sourceRecordPath, "$[1].transformations[0]");
        (0, assert_1.equal)(overlay.patches[0].productionPath, oldIndex.selected.get("2").sourceRecordPath);
        (0, assert_1.equal)(overlay.decision.evaluation.binding.ambiguous, oldIndex.ambiguous.has("3") ? 1 : 0);
    });
    it("does not mutate K15, production, or expose Character/application APIs", async () => {
        ...
        (0, assert_1.equal)(compactOverlay.apply, undefined);
        (0, assert_1.equal)(compactOverlay.merge, undefined);
        (0, assert_1.equal)(compactOverlay.write, undefined);
        const parent = (0, path_1.resolve)(__dirname, "..");
        const sourceRoot = (0, path_1.basename)(parent).toLowerCase() === "lib" ? (0, path_1.resolve)(parent, "..") : parent;
