...
(0, mocha_1.describe)("Stage asset mirror", () => {
    (0, mocha_1.it)("collects event, reward, enemy, Quest and Frontier assets under stable paths", () => {
        ...
        const requests = (0, game_db_stage_assets_1.collectStageAssetRequests)(dataset, itemCatalog, frontier, undefined, awakeningMedals);
        ...
        (0, assert_1.equal)(paths.includes("item/awaken/en/thumb/thumb_awaken_items_33704/thumb_awaken_items_33704.png"), true);
        ...
        (0, assert_1.equal)(paths.includes("item/other/en/thumb/thumb_linkskill_orb_00001/thumb_linkskill_orb_00001.png"), true);
        (0, assert_1.equal)(paths.includes("item/wallpaper/0076/icon_0076.png"), true);
        (0, assert_1.equal)(paths.includes("item/wallpaper/0076/thumb_0076.png"), true);
        (0, assert_1.equal)(paths.includes("item/wallpaper/0076/full_0076.png"), true);
