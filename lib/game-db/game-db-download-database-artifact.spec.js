...
describe("game DB manual database artifact acquisition", function () {
    ...
    it("validates an offline artifact only with validated descriptor lineage", async () => {
        ...
        try {
            ...
            const result = await (0, game_db_download_database_artifact_1.runDownloadDatabaseArtifact)({ descriptorJson: descriptorPath, artifactPath, storeRoot: (0, path_1.join)(root, "store"), authorizeDownload: false, dryRun: false });
