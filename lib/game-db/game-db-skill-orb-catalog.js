...
exports.SKILL_ORB_CONTRACT_VERSION = "1.1.0";
...
function buildCondition(row, cards, categories, uniqueInfos, uniqueInfoRelationsBySet, cardsByUniqueInfo, categoryRelationsByCategory) {
...
function validateSkillOrbCatalog(catalog) {
    if (catalog.schemaVersion !== 1 || !["1.0.0", exports.SKILL_ORB_CONTRACT_VERSION].includes(catalog.parserVersion))
