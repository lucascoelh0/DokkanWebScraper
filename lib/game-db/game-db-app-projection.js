...
function portraitSpecForCharacter(character) {
    if (character.raw.element) {
        return (0, portrait_assets_1.portraitSpecFromElement)(character.id, character.rarity, character.raw.element);
    }
    return (0, portrait_assets_1.portraitSpecFromTypeAndClass)(character.id, character.rarity, typeDigit(character.type), character.characterClass === "None" ? "None" : character.characterClass);
}
...
function projectGameDbCharacterToDokkanpanion(character) {
    ...
    return {
        ...
        cost: character.cost,
        portraitURL: (0, portrait_assets_1.portraitOutputUrl)(portraitFilename),
        portraitFilename,
        portraitSpec,
        artURL: (0, portrait_assets_1.cardArtUrlFromCardId)(character.id),
