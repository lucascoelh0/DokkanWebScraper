...
(0, mocha_1.describe)("mapActiveSkillSets", function () {
    ...
    (0, mocha_1.it)("preserves the official OR-of-AND activation condition without flattening it", () => {
        ...
        (0, assert_1.deepEqual)(mapped.activationCondition?.status, "supported");
    ...
    (0, mocha_1.it)("uses the compiled first-party causality independently from localized display text", () => {
        const [mapped] = (0, game_db_active_skill_1.mapActiveSkillSets)([{ id: "174", card_id: "1025561", active_skill_set_id: "174" }], new Map([[
                "174",
                {
                    id: "174",
        ...
        (0, assert_1.deepEqual)(category.predicate.evidenceStatus, "supported");
    });
    (0, mocha_1.it)("fails closed for an unsupported type-34 scope operand", () => {
        ...
        if (category.op !== "predicate")
            throw new Error("expected the category predicate");
        (0, assert_1.deepEqual)(category.predicate.kind, "unknown");
        (0, assert_1.deepEqual)(category.predicate.evidenceStatus, "unknown");
    });
    (0, mocha_1.it)("builds a form-keyed contract and omits cards with conflicting Active Skill trees", () => {
        const contract = (0, game_db_active_skill_1.buildGameDbActiveSkillActivationContract)({
            active_skill_sets: [
        ...
        (0, assert_1.deepEqual)(contract.get("1022091")?.status, "supported");
        const expression = contract.get("1022091")?.expression;
        (0, assert_1.deepEqual)(expression?.op === "predicate"
            ? expression.predicate.kind
            : undefined, "attacks_received");
        (0, assert_1.deepEqual)(contract.has("9999991"), false);
    });
