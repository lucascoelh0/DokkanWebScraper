...
(0, mocha_1.describe)("Created Domain dataset release identity", function () {
    (0, mocha_1.it)("revisions both settings-backed and fallback dataset versions", () => {
        ...
        (0, assert_1.equal)((0, game_db_dataset_1.datasetVersionFromSourceSettings)("2026-01-01T00:00:00.000Z", undefined, ["glb-db-1782367825"]), "glb-db-1782367825__created-domain-effect-v2");
    });
