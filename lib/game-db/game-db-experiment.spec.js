...
(0, mocha_1.describe)("canonical card release dates", function () {
    (0, mocha_1.it)("keeps an alternative art variant at the original card release date", () => {
        ...
        const [snapshot] = (0, game_db_experiment_1.buildGameDbCharacterSnapshots)(["1034481"], tables);
        (0, assert_1.equal)(snapshot.cardUniqueInfoId, "326");
        (0, assert_1.equal)(snapshot.releaseDate, "2024-04-26T06:00:00.000Z");
        (0, assert_1.equal)(snapshot.releaseStates?.initial.releaseDate, "2024-04-26T06:00:00.000Z");
    });
});
