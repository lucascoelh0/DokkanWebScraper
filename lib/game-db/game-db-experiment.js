...
exports.loadRequiredGameDbTables = exports.maybeReadFyiExperimentCharacters = exports.buildGameDbComparisonReport = exports.buildGameDbCharacterSnapshots = exports.finalizeFormRelations = exports.readSourceSettings = exports.parseCardIds = exports.REQUIRED_GAME_DB_TABLES = exports.DEFAULT_GOLDEN_CARD_IDS = void 0;
...
exports.REQUIRED_GAME_DB_TABLES = [
    "active_skill_sets",
    "active_skills",
    "card_active_skills",
...
function buildGameDbCharacterSnapshots(cardIds, tables) {
    ...
    return cardIds.map(cardId => {
        ...
        return {
            ...
            leaderSkill,
            passiveSkillSet,
            superAttacks: (0, game_db_super_attack_1.mapSuperAttacks)(cardId, cardSpecialsByCardId.get(cardId) ?? [], specialSetById),
...
async function main() {
    ...
    const dokkanpanionProjection = (0, game_db_app_projection_1.projectGameDbCharactersToDokkanpanion)(characters);
