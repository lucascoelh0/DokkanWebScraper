...
exports.loadRequiredGameDbTables = exports.maybeReadFyiExperimentCharacters = exports.buildGameDbComparisonReport = exports.buildGameDbCharacterSnapshots = exports.finalizeFormRelations = exports.parseCardIds = exports.REQUIRED_GAME_DB_TABLES = exports.DEFAULT_GOLDEN_CARD_IDS = exports.readSourceSettings = void 0;
...
function buildGameDbCharacterSnapshots(cardIds, tables) {
    ...
    return cardIds.map(cardId => {
        ...
        const leaderSkill = leaderSkillSetId && leaderSkillSetRow
            ? {
                id: leaderSkillSetId,
            ...
            : undefined;
        const passiveSkillSet = passiveSkillSetId && passiveSkillSetRow
            ? {
        ...
        const hasSeza = rarity === character_1.Rarities.LR
        ...
        return {
            ...
            cardUniqueInfoId: (0, game_db_source_1.normalizeDbId)(card.card_unique_info_id) ?? "",
            ...
            releaseDate: (0, game_db_source_1.parseDbDate)(card.open_at),
            baseMaxLevel: (0, game_db_source_1.parseDbInt)(card.lv_max) ?? 0,
            baseMaxSaLevel: (0, game_db_source_1.parseDbInt)(card.skill_lv_max) ?? 0,
            stats: {
            ...
            leaderSkill,
            passiveSkillSet,
            superAttacks: (0, game_db_super_attack_1.mapSuperAttacks)(cardId, cardSpecialsByCardId.get(cardId) ?? [], specialSetById, specialEffectsBySetId),
            activeSkillSets: (0, game_db_active_skill_1.mapActiveSkillSets)(activeSkillRelationsByCardId.get(cardId) ?? [], activeSkillSetById, activeSkillEffectsBySetId, ultimateSpecialById),
            standbySkillSets,
            finishSkillSets,
            formRelations,
            growthSteps,
...
async function loadRequiredGameDbTables(sourceConfig) {
    ...
    const optionalEntries = await Promise.all(game_db_table_inventory_1.SUPER_ATTACK_EFFECT_GAME_DB_TABLES.map(async (tableName) => {
        try {
