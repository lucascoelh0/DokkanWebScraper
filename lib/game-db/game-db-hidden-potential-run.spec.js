...
(0, mocha_1.it)("only audited primary payloads and the exact scoped counts are accepted", () => {
    for (const primarySha256 of [game_db_hidden_potential_run_1.PRIMARY_SHA, game_db_hidden_potential_run_1.KI_PRIMARY_SHA]) {
        const roster = { primaryCount: 1442, enrichmentCount: 2768, primarySha256 };
        assert_1.strict.doesNotThrow(() => (0, game_db_hidden_potential_run_1.assertSupportedRoster)(roster));
        assert_1.strict.throws(() => (0, game_db_hidden_potential_run_1.assertSupportedRoster)({ ...roster, primaryCount: 1441 }));
        assert_1.strict.throws(() => (0, game_db_hidden_potential_run_1.assertSupportedRoster)({ ...roster, enrichmentCount: 2767 }));
    }
    assert_1.strict.throws(() => (0, game_db_hidden_potential_run_1.assertSupportedRoster)({ primaryCount: 1442, enrichmentCount: 2768, primarySha256: "0".repeat(64) }));
});
