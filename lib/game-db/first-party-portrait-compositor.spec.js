...
(0, mocha_1.describe)("first-party portrait compositor", function () {
    ...
    (0, mocha_1.it)("composes a deterministic 150px portrait from explicit local official layers", async () => {
        ...
        (0, assert_1.equal)(firstArtifacts.portrait.equals(legacyCombined), true);
        ...
        (0, assert_1.deepEqual)(await rgbaAt(firstArtifacts.portraitLayers.overlay, 0, 78), [255, 255, 0, 255]);
        (0, assert_1.deepEqual)(await rgbaAt(firstArtifacts.portraitLayers.overlay, 71, 149), [255, 255, 0, 255]);
        (0, assert_1.deepEqual)(await rgbaAt(firstArtifacts.portraitLayers.overlay, 93, 0), [0, 255, 255, 255]);
        (0, assert_1.deepEqual)(await rgbaAt(firstArtifacts.portraitLayers.overlay, 149, 56), [0, 255, 255, 255]);
        (0, assert_1.equal)((await rgbaAt(firstArtifacts.portraitLayers.overlay, 92, 0))[3], 0);
    });
