...
exports.GAME_DB_DATASET_CONTENT_REVISION = "created-domain-effect-v2";
...
async function enrichGameDbDatasetCreatedDomainsIfSupported(options) {
    ...
    if (sourceSnapshotId !== game_db_dokkan_field_created_domain_1.CREATED_DOMAIN_AUDITED_SNAPSHOT_ID) {
        return {
            characters: options.characters,
            report: { status: "unsupported-snapshot", sourceSnapshotId, linkCount: 0 },
        };
    }
    const sidecarArtifact = (0, game_db_dokkan_field_sidecar_artifact_1.buildGameDbDokkanFieldSidecarArtifact)((0, game_db_dokkan_field_sidecar_1.buildGameDbDokkanFieldSidecar)(sourceSnapshotId, fieldTables));
    const activeSkillSetsCsv = await (0, promises_1.readFile)((0, path_1.resolve)(options.sourceConfig.dataDir, "active_skill_sets.csv"));
    const enriched = (0, game_db_dokkan_field_created_domain_1.buildSnapshotAuditedCreatedDomainEnrichedCharacters)({
        characters: options.characters,
