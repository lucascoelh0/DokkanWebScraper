...
exports.runDownloadDatabaseArtifact = exports.acquireDatabaseArtifact = exports.httpsDatabaseArtifactTransport = exports.inspectDownloadedDatabaseArtifact = exports.readAndValidateDatabaseDescriptor = exports.validateClientAssetsDatabaseDescriptor = exports.parseDownloadDatabaseArtifactArgs = exports.DEFAULT_DATABASE_ARTIFACT_TIMEOUT_MS = exports.DEFAULT_DATABASE_ARTIFACT_MAX_BYTES = void 0;
...
function parseDownloadDatabaseArtifactArgs(argv) {
    ...
    if (authorizeDownload && !descriptorJson)
        throw new Error("--authorize-download requires --descriptor-json");
...
exports.inspectDownloadedDatabaseArtifact = inspectDownloadedDatabaseArtifact;
...
exports.httpsDatabaseArtifactTransport = {
    get(url, options) {
...
async function runDownloadDatabaseArtifact(options, dependencies = {}) {
    if (options.artifactPath)
        return { mode: "artifact_validation", inspection: await inspectDownloadedDatabaseArtifact(options.artifactPath) };
    ...
    const result = await acquireDatabaseArtifact({ descriptor, storeRoot: options.storeRoot, transport: dependencies.transport ?? exports.httpsDatabaseArtifactTransport });
