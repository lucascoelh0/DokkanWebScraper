...
exports.buildStageDelivery = exports.DEFAULT_STAGE_SHARD_MAX_EXPANDED_BYTES = exports.STAGE_DELIVERY_CONTRACT_VERSION = exports.STAGE_DELIVERY_CONTRACT = void 0;
...
function buildStageDelivery(dataset, shardMaxExpandedBytes = exports.DEFAULT_STAGE_SHARD_MAX_EXPANDED_BYTES) {
    ...
    const shards = pendingShards.map(shard => {
        ...
        const gzip = (0, zlib_1.gzipSync)(bytes, { level: 9 });
    ...
    const catalogGzip = (0, zlib_1.gzipSync)(catalogBytes, { level: 9 });
