...
function buildStageDelivery(dataset, shardMaxExpandedBytes = exports.DEFAULT_STAGE_SHARD_MAX_EXPANDED_BYTES, compressionLevel = 9) {
    ...
    const catalog = {
        ...
        assetBaseUrl: exports.DEFAULT_STAGE_ASSET_BASE_URL,
        count: items.length,
