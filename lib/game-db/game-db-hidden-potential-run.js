...
exports.run = exports.writeCandidate = exports.readRoster = exports.readPayload = exports.bounded = exports.parseArgs = exports.sha256 = exports.assertSupportedRoster = exports.KI_PRIMARY_SHA = exports.PRIMARY_SHA = exports.RUNTIME_SHA = exports.DB_SHA = exports.HIPO_ROOT = void 0;
...
exports.KI_PRIMARY_SHA = "db6ee0013743dd1886d7743b92e4e5ce153168af7e0bdf7165c5490e089ecdfc";
function assertSupportedRoster(roster) {
    (0, game_db_hidden_potential_core_1.check)(roster.primaryCount === 1442 && roster.enrichmentCount === 2768
        && [exports.PRIMARY_SHA, exports.KI_PRIMARY_SHA].includes(roster.primarySha256), "Unknown scoped roster snapshot");
}
exports.assertSupportedRoster = assertSupportedRoster;
