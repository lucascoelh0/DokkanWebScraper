...
exports.mapActiveSkillSets = exports.buildGameDbActiveSkillActivationContract = exports.activeSkillActivationCondition = exports.compileSkillCausalityCondition = void 0;
 ...
 */
function compileSkillCausalityCondition(raw, skillCausalityById, categoryById) {
...
exports.compileSkillCausalityCondition = compileSkillCausalityCondition;
function activeSkillActivationCondition(activeSkillSet, skillCausalityById, categoryById) {
    const compiled = compileSkillCausalityCondition(activeSkillSet.causality_conditions, skillCausalityById, categoryById);
    if (!compiled)
        return undefined;
    return {
