...
async function runEventsE2(options = {}) {
    ...
    const baseline = JSON.parse(await (0, promises_1.readFile)(sourcePath("events-e0-baseline.json"), "utf8")), e1Manifest = JSON.parse(await (0, promises_1.readFile)((0, path_1.resolve)(e1Dir, "events-e1-manifest.json"), "utf8"));
