...
async function runEventsE5(options = {}) {
    ...
    const e4Manifest = JSON.parse(await (0, promises_1.readFile)((0, path_1.resolve)(e4Dir, "events-e4-manifest.json"), "utf8")), e2Manifest = JSON.parse(await (0, promises_1.readFile)((0, path_1.resolve)(e2Dir, "events-e2-manifest.json"), "utf8")), e1Manifest = JSON.parse(await (0, promises_1.readFile)((0, path_1.resolve)(e1Dir, "events-e1-manifest.json"), "utf8"));
    const [e4Bytes, e4CoverageBytes, e4ValidationBytes, e2Bytes, e1Bytes] = await Promise.all([(0, promises_1.readFile)((0, path_1.resolve)(e4Dir, e4Manifest.fileName)), (0, promises_1.readFile)((0, path_1.resolve)(e4Dir, e4Manifest.coverage.fileName)), (0, promises_1.readFile)((0, path_1.resolve)(e4Dir, e4Manifest.validation.fileName)), (0, promises_1.readFile)((0, path_1.resolve)(e2Dir, e2Manifest.fileName)), (0, promises_1.readFile)((0, path_1.resolve)(e1Dir, e1Manifest.fileName))]);
    memory();
