...
describe("buildAcquisitionNavigationDataset", () => {
    it("maps acquisition sources to stable app navigation targets", () => {
        const dataset = (0, fyi_acquisition_navigation_1.buildAcquisitionNavigationDataset)({
        ...
        (0, assert_1.equal)(dataset.sourceCount, 5);
...
//# sourceMappingURL=fyi-acquisition-navigation.spec.js.map