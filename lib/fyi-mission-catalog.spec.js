...
describe("buildMissionCatalog", () => {
    it("normalizes panel and event mission datasets into shared groups and missions", () => {
        ...
        (0, assert_1.equal)(dataset.groupCount, 5);
        (0, assert_1.equal)(dataset.missionCount, 4);
        ...
        (0, assert_1.deepEqual)({
            ...
            panelRewardKey: panelMission?.rewards[0]?.itemKey,
            eventGroupKey: eventMission?.groupKey,
            eventPreviewRewardKey: eventCategory?.previewRewards?.[0]?.itemKey,
            frontierChapterGroupKey: frontierChapterMission?.groupKey,
            frontierNodeGroupKey: frontierNodeMission?.groupKey,
            frontierNodeRewardKey: frontierNodeMission?.rewards[0]?.itemKey,
        }, {
            ...
            panelRewardKey: "Point::Stone:11",
            eventGroupKey: "event-category:700",
            eventPreviewRewardKey: "ExclusiveSkillOrb:8001",
            frontierChapterGroupKey: "frontier-chapter:2001",
            frontierNodeGroupKey: "frontier-node:2001:20010102",
            frontierNodeRewardKey: "CardSkinItem:1:1029571:1:internal:OriginMapScene?episode=2001&battle=20010102",
        });
    });
});
