...
function buildWt6(source, lineage, aggregateSha256, implementationAggregateSha256, scan, memory) {
    ...
    const dataset = {
        schemaVersion: 1, contract: "dokkan-world-tournament-readiness", contractVersion: "0.12.0", collectionMode: "offline_double_generation_no_requests", productionMutation: false, defaultEnabled: false, source, lineage, determinism: { passCount: 2, upstreamArtifactCount: 18, wt6OutputFileCount: 3, totalArtifactCount: 21, upstreamAggregateSha256: aggregateSha256, implementationAggregateSha256, upstreamByteIdentical: true, wt6OutputByteIdentical: true }, security: scan, memory, decisions,
...
function validateWt6(dataset) {
    const failures = [];
    if (dataset.schemaVersion !== 1 || dataset.contract !== "dokkan-world-tournament-readiness" || dataset.contractVersion !== "0.12.0" || dataset.collectionMode !== "offline_double_generation_no_requests" || dataset.productionMutation || dataset.defaultEnabled)
