...
function appIdentityProof(identity = syntheticAppIdentity) {
    return {
        ...
        evidence: {
            ...
            tool: { name: "aapt", executableSha256: wt_first_party_app_identity_1.WT_FIRST_PARTY_AAPT_SHA256, version: wt_first_party_app_identity_1.WT_FIRST_PARTY_AAPT_VERSION, command: "aapt dump badging <pinned-apk>" },
