...
(0, mocha_1.describe)("parseWranglerBucketSize", function () {
    ...
    (0, mocha_1.it)("rejects a transiently empty bucket report when verified remote objects already exist", () => {
        (0, assert_1.throws)(() => (0, publish_r2_1.assertBucketSizeCanContainVerifiedObjects)((0, publish_r2_1.parseWranglerBucketSize)("0 B"), 69920337, 0), /inconsistent with at least 69920337 verified existing bytes/);
        (0, publish_r2_1.assertBucketSizeCanContainVerifiedObjects)((0, publish_r2_1.parseWranglerBucketSize)("1.1 GB"), 69920337, 0);
        (0, publish_r2_1.assertBucketSizeCanContainVerifiedObjects)((0, publish_r2_1.parseWranglerBucketSize)("0 B"), 69920337, 69920337);
    });
});
...
(0, mocha_1.describe)("parsePublishArgs", function () {
    ...
    (0, mocha_1.it)("parses explicit full audit without making layered portrait skipping valid", () => {
        const options = (0, publish_r2_1.parsePublishArgs)(["--bucket", "test", "--contract-lane", "v2", "--full-audit"]);
        (0, assert_1.equal)(options.fullAudit, true);
    ...
    (0, mocha_1.it)("parses receipt bootstrap only as a pinned remote full audit", () => {
        const baseline = [
            "--bucket", "test",
            "--contract-lane", "v2",
            "--full-audit",
        ...
        const options = (0, publish_r2_1.parsePublishArgs)(baseline);
        (0, assert_1.equal)(options.verificationOnly, true);
        (0, assert_1.equal)(options.fullAudit, true);
        (0, assert_1.equal)(options.dryRun, false);
        (0, assert_1.equal)(options.target, "remote");
        (0, assert_1.equal)(options.promoteProduction, false);
        for (const invalid of [
            ...
            (0, assert_1.throws)(() => (0, publish_r2_1.parsePublishArgs)(invalid));
        }
    });
});
...
(0, mocha_1.describe)("buildPortraitEntries", function () {
    ...
    (0, mocha_1.it)("validates channel-scoped static and typed layer objects against their embedded hashes", async () => {
        await withTempRoot(async (root) => {
            ...
            (0, assert_1.deepEqual)(entries.map(entry => entry.sizeBytes), [staticBytes.byteLength, layerBytes.byteLength]);
            (0, assert_1.equal)((await entries[0].loadBytes?.())?.equals(staticBytes), true);
        });
    });
    (0, mocha_1.it)("rejects cross-channel, cross-lane, malformed, missing, mismatched and traversing objects", async () => {
        await withTempRoot(async (root) => {
            ...
            const [wrongHashDescriptor] = await (0, publish_r2_1.buildPortraitEntries)([{ objectKey: wrongHash, layerKind: "thumb" }], root, {
                channel: "staging",
                contractLane: "v2",
            });
            await (0, assert_1.rejects)(wrongHashDescriptor.loadBytes(), /changed after descriptor creation/);
