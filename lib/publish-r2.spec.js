...
(0, mocha_1.describe)("buildRemoteDatasetObjectKey", function () {
    ...
    (0, mocha_1.it)("keeps staging manifests and immutable payloads outside production keys", () => {
        ...
        (0, assert_1.equal)((0, publish_r2_1.buildCharacterManifestObjectKey)("staging"), "staging/characters-manifest.json");
        (0, assert_1.equal)((0, publish_r2_1.buildRemoteDatasetObjectKey)(manifest, "staging"), `staging/releases/2026-08-22T21-14-10.019Z/${"a".repeat(64)}/characters.json.gz`);
    });
});
...
(0, mocha_1.describe)("parsePublishArgs", function () {
    (0, mocha_1.it)("requires and validates the expected remote baseline SHA", () => {
        (0, assert_1.throws)(() => (0, publish_r2_1.parsePublishArgs)(["--bucket", "test", "--expected-remote-baseline-sha256", "--remote"]), /requires a value/);
        (0, assert_1.throws)(() => (0, publish_r2_1.parsePublishArgs)(["--bucket", "test", "--expected-remote-baseline-sha256="]), /requires a value/);
        (0, assert_1.throws)(() => (0, publish_r2_1.parsePublishArgs)(["--bucket", "test", "--expected-remote-baseline-sha256", "not-a-sha"]), /Invalid --expected-remote-baseline-sha256/);
    ...
    (0, mocha_1.it)("requires isolated portrait handling and state for staging", () => {
        (0, assert_1.throws)(() => (0, publish_r2_1.parsePublishArgs)(["--bucket", "test", "--channel", "staging"]), /requires --skip-portraits/);
        ...
        (0, assert_1.equal)(staging.manifestObjectKey, "staging/characters-manifest.json");
        (0, assert_1.equal)(staging.statePath.endsWith("r2-publish-state-staging.json"), true);
        (0, assert_1.throws)(() => (0, publish_r2_1.parsePublishArgs)(["--bucket", "test", "--channel", "preview", "--skip-portraits"]), /Invalid dataset publication channel/);
    });
});
