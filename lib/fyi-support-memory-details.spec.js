...
(0, mocha_1.describe)("buildSupportMemoryDetailsDataset", function () {
    (0, mocha_1.it)("joins support memories with category applicability and acquisition sources", () => {
        ...
        (0, assert_1.equal)(memory.unlockAcquisition?.sources[0].subtitle, undefined);
        (0, assert_1.equal)(memory.unlockAcquisition?.sources[0].navigationTarget?.missionKey, "event:21146");
        (0, assert_1.equal)(memory.unlockAcquisition?.sources[0].stageReferences?.[0].id, "9240010");
        (0, assert_1.equal)(memory.unlockAcquisition?.sources[0].stageReferences?.[0].eventName, "Support Memory Event");
