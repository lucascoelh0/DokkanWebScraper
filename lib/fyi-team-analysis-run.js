...
exports.runFyiTeamAnalysis = void 0;
...
async function runFyiTeamAnalysis(options) {
    ...
    const dataset = (0, team_analysis_1.buildTeamAnalysisDataset)(characters, catalog.characters, {
    ...
    (0, team_analysis_1.assertValidTeamAnalysisDataset)(dataset, characters, catalog.characters);
