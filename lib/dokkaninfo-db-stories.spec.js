...
describe("DokkanInfo DB Stories dataset", () => {
    ...
    it("discovers Growth events from the server component payload", () => {
        ...
        (0, assert_1.deepEqual)((0, dokkaninfo_db_stories_1.mapGrowthIndex)(dom.window.document), [
    ...
    it("discovers Limited events from the server component payload", () => {
        ...
        (0, assert_1.deepEqual)((0, dokkaninfo_db_stories_1.mapLimitedIndex)(dom.window.document), [
    ...
    it("discovers Challenge events from the server component payload", () => {
        ...
        (0, assert_1.deepEqual)((0, dokkaninfo_db_stories_1.mapChallengeIndex)(dom.window.document), [
    ...
    it("discovers Bonus events from the server component payload", () => {
        ...
        (0, assert_1.deepEqual)((0, dokkaninfo_db_stories_1.mapBonusIndex)(dom.window.document), [
    ...
    it("discovers Quest areas from server-rendered links", () => {
        ...
        `);
        (0, assert_1.deepEqual)((0, dokkaninfo_db_stories_1.mapQuestIndex)(dom.window.document), [
