...
async function writeDokkanFyiSupportMemoryDetails(dataset) {
    ...
    const manifestPath = (0, path_1.resolve)(outputDir, "support-memory-manifest.json");
    await (0, promises_1.mkdir)(outputDir, { recursive: true });
    await (0, format_json_1.writeFormattedJson)(outputPath, resolvedDataset);
    await (0, support_memory_dataset_artifacts_1.writeSupportMemoryDatasetManifest)(resolvedDataset, outputPath, manifestPath);
    return outputPath;
}
...
function cleanAcquisitionText(value) {
