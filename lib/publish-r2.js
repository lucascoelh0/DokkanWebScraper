...
function buildRemoteDatasetObjectKey(manifest, channel = "production", contractLane = "v1") {
    ...
    return (0, dataset_publication_channel_1.contractLaneObjectKey)(channel, contractLane, `releases/${datasetVersionSlug(manifest.datasetVersion)}/${manifest.sha256.toLowerCase()}/${fileName}`);
}
...
async function readPublishState(statePath, channel, contractLane) {
