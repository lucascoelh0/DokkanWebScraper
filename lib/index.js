...
async function saveDokkanResults() {
    ...
    if (!(0, fs_1.existsSync)((0, path_1.resolve)(__dirname, 'data/latest'))) {
        (0, fs_1.mkdirSync)('data/latest');
    }
...
async function saveCharacterData(fileName, data, currentDate) {
    await saveData(fileName, data);
    const artifact = (0, dataset_artifacts_1.buildCharacterDatasetArtifact)(data, {
        datasetVersion: currentDate.toISOString(),
        generatedAt: currentDate.toISOString(),
        fileName: "characters.json.gz",
    });
    await (0, dataset_artifacts_1.writeCharacterDatasetBundle)((0, path_1.resolve)(__dirname, "data/latest"), artifact, {
