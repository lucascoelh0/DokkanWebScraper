...
exports.validatedChancePercent = exports.TEAM_ANALYSIS_CHANCE_LEXICON = void 0;
...
exports.TEAM_ANALYSIS_CHANCE_LEXICON = {
    "a chance": {
        term: "a chance",
        percent: 10,
        origin: {
        ...
        evidence: [
            ...["726", "818", "955", "1219", "1342", "1343", "1932", "2017"].map(passiveSkillSetId => ({
                ...
                efficacyType: 81,
                valueField: "eff_value3",
                semantic: "additional_to_super",
            })),
        ],
    },
    medium: {
...
function validatedChancePercent(sourceTerm, semantic) {
    const term = sourceTerm.trim().toLowerCase();
    const entry = exports.TEAM_ANALYSIS_CHANCE_LEXICON[term];
    if (!entry) {
        return undefined;
    }
...
exports.validatedChancePercent = validatedChancePercent;
//# sourceMappingURL=team-analysis-chance-lexicon.js.map