...
function buildCategoryContextDataset(input) {
    ...
    const characters = input.characters
        .map(character => mapCharacterCategoryContextEntry(character, categoryNameToId, categoryNameById, input.categories.categories))
...
function mapCharacterCategoryContextEntry(character, categoryNameToId, categoryNameById, categories) {
    const categoryIds = uniqueSortedIds((character.categories ?? [])
