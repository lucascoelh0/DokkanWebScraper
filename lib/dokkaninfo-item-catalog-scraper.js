...
exports.parseDokkanInfoItemCategory = exports.buildDokkanInfoItemCatalogManifest = exports.writeDokkanInfoItemCatalog = exports.awakeningMedalBackground = exports.getDokkanInfoItemCatalog = exports.DEFAULT_ITEM_CATEGORIES = void 0;
...
async function buildAwakeningMedalCategory(config) {
...
function awakeningMedalBackground(rarityBucket) {
    const tier = ["bronze", "silver", "gold", "rainbow"][rarityBucket];
    if (!tier) {
        return undefined;
    }
    return {
...
exports.awakeningMedalBackground = awakeningMedalBackground;
