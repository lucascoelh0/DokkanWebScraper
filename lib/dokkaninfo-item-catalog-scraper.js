...
exports.parseDokkanInfoItemCategory = exports.writeDokkanInfoItemCatalog = exports.getDokkanInfoItemCatalog = exports.DEFAULT_ITEM_CATEGORIES = void 0;
...
async function writeDokkanInfoItemCatalog(dataset) {
    ...
    const outputPath = (0, path_1.resolve)(outputDir, "item-catalog.json");
