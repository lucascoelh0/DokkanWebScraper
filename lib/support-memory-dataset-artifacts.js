...
exports.contentTypeForAsset = exports.collectSupportMemoryAssetRefs = exports.inspectSupportMemoryDatasetAssets = exports.writeSupportMemoryDatasetManifest = exports.inspectSupportMemoryDatasetArtifacts = exports.SUPPORT_MEMORY_GAME_ASSET_ROOT = exports.SUPPORT_MEMORY_ASSET_ROOT = exports.SUPPORT_MEMORY_ASSET_PREFIX = exports.SUPPORT_MEMORY_MANIFEST_FILE_NAME = exports.SUPPORT_MEMORY_DETAILS_FILE_NAME = void 0;
...
exports.SUPPORT_MEMORY_GAME_ASSET_ROOT = "data/support-memories/assets/game";
...
async function inspectSupportMemoryDatasetAssets(dataset, projectRoot = process.cwd()) {
    ...
    const assets = [];
    const assetRoots = [exports.SUPPORT_MEMORY_ASSET_ROOT, exports.SUPPORT_MEMORY_GAME_ASSET_ROOT].map(root => (0, path_1.resolve)(projectRoot, root));
