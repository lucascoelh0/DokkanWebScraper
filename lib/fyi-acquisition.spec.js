...
describe("buildAcquisitionDataset", () => {
    it("limits historical stage references to the current mission range", () => {
        (0, assert_1.deepEqual)([...(0, fyi_acquisition_1.parseMissionStageLevels)("Clear Stages 22 to 27.")], [22, 23, 24, 25, 26, 27]);
        (0, assert_1.deepEqual)([...(0, fyi_acquisition_1.parseMissionStageLevels)("Clear Stages 1, 3, 5, 7 and 9.")], [1, 3, 5, 7, 9]);
        const stages = new Map([
            ...
            ["17380223", {
                    ...
                    fyiSourcePath: "https://dokkan.fyi/stages/17380223",
                    eventType: "challenge",
                    eventId: "1738",
            ...
            ["17380274", {
                    ...
                    fyiSourcePath: "https://dokkan.fyi/stages/17380274",
                    eventType: "challenge",
                    eventId: "1738",
                    eventName: "Current Edition",
                }],
        ]);
        (0, assert_1.deepEqual)((0, fyi_acquisition_1.resolveMissionStageReferences)("1738", "27667", "Clear Stages 22 to 27.", new Map([["1738:27667", ["17010015", "17380223", "17380274"]]]), stages)?.map(stage => stage.id), ["17380223", "17380274"]);
    });
    it("groups multiple source types under a stable item key", () => {
        ...
        (0, assert_1.equal)(dataset.itemCount, 4);
        (0, assert_1.equal)(dataset.sourceCount, 7);
        ...
        (0, assert_1.equal)(frontierSkin?.itemId, "1");
        (0, assert_1.equal)(frontierSkin?.cardId, "1029571");
        (0, assert_1.equal)(frontierSkin?.step, 1);
        (0, assert_1.equal)(frontierSkin?.sources[0].kind, "frontier-node-mission");
        (0, assert_1.equal)(frontierSkin?.sources[0].frontierNodeId, "20010102");
        const orb = dataset.items.find(item => item.key === "EquipmentSkillItem:9000");
        (0, assert_1.equal)(orb?.sources[0].kind, "dokkaninfo-event-reward");
        (0, assert_1.equal)(orb?.sources[0].eventStageId, "1330010");
        (0, assert_1.deepEqual)(stone?.sources.find(source => source.kind === "event-mission")?.stageReferences, [
            {
                id: "7960010",
                title: "Level 3: Mission Event Stage 3",
                level: 3,
                difficulty: "SUPER",
                sourcePath: "https://dokkaninfo.com/events/challenge/796/7960010",
                fyiSourcePath: "https://dokkan.fyi/stages/7960010",
                eventType: "challenge",
                eventId: "796",
