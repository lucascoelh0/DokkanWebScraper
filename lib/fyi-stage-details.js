...
exports.collectStageDetailAssets = exports.mirrorStageDetailAssets = exports.mapStageDetailImages = exports.mapStageDetailFromFyi = exports.removeUnmirroredStageDetailAssets = exports.localizeStageDetailAssets = exports.writeDokkanFyiStageDetails = exports.discoverStageDetailIds = exports.collectStageDetailIds = exports.getDokkanFyiStageDetails = void 0;
...
function collectStageDetailIds(sources) {
...
exports.collectStageDetailIds = collectStageDetailIds;
function discoverStageDetailIds(projectRoot = process.cwd()) {
    const eventStages = readJsonOrUndefined((0, path_1.resolve)(projectRoot, "data/stages/latest/event-stages.json"));
    const questStoryStages = readJsonOrUndefined((0, path_1.resolve)(projectRoot, "data/stages/latest/quest-story-stages.json"));
    const supportMemoryDetails = readJsonOrUndefined((0, path_1.resolve)(projectRoot, "data/support-memories/latest/support-memory-details.json"));
    return collectStageDetailIds({
        ...
        supportMemoryStageIds: supportMemoryDetails?.entries.flatMap(entry => [entry.unlockAcquisition, entry.filmAcquisition]
            .flatMap(acquisition => acquisition?.sources ?? [])
            .flatMap(source => source.stageReferences ?? [])
            .map(reference => reference.id)),
    });
}
exports.discoverStageDetailIds = discoverStageDetailIds;
