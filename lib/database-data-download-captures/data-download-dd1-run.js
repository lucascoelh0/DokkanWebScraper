...
if ((0, v8_1.getHeapStatistics)().heap_size_limit >= 1024 * 1024 * 1024)
    throw new Error("DD1 requires a Node heap below 1 GiB");
...
const dataset = (0, data_download_dd1_1.buildDd1)(loaded, lock, (0, data_download_core_1.buildDd0)(lock, loaded, external));
