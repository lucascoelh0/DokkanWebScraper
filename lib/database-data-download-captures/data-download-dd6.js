...
async function buildDd6(root, lock, dd2) {
    ...
    const rows = [
        ...
        { subject: "manual_database_downloader_safety", prior: "current_downloader", classification: "representation_mismatch", units: 1, reason: "current helper accepts arbitrary URLs, follows redirects, persists full URL metadata and writes before integrity validation" },
