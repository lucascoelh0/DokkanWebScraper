...
function fixture() {
    ...
    const candidate = (stateKey, value, databaseRuleKey) => ({ stateKey, value, negated: false, databaseRuleKey, databaseLowerSignature: JSON.stringify({ logicalContext: "all", negated: false }), currentExactSignatures: [signature(value)] });
