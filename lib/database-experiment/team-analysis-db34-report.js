...
exports.renderDatabaseTeamAnalysisDb34Report = void 0;
const rows = (values) => Object.entries(values).map(([key, value]) => `| \`${key}\` | ${value} |`).join("\n");
function renderDatabaseTeamAnalysisDb34Report(dataset, coverage) {
...
exports.renderDatabaseTeamAnalysisDb34Report = renderDatabaseTeamAnalysisDb34Report;
//# sourceMappingURL=team-analysis-db34-report.js.map