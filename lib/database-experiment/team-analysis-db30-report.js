...
exports.renderDatabaseTeamAnalysisDb30Report = void 0;
function rows(v) { return Object.entries(v).map(([k, n]) => `| ${k} | ${n} |`).join("\n"); }
function renderDatabaseTeamAnalysisDb30Report(c) {
    return `# Database Team Analysis experiment — DB30 native efficacy removal
...
exports.renderDatabaseTeamAnalysisDb30Report = renderDatabaseTeamAnalysisDb30Report;
//# sourceMappingURL=team-analysis-db30-report.js.map