...
exports.renderDatabaseTeamAnalysisDb29Report = void 0;
function rows(values) { return Object.entries(values).map(([value, count]) => `| ${value} | ${count} |`).join("\n"); }
function renderDatabaseTeamAnalysisDb29Report(dataset, coverage) {
...
exports.renderDatabaseTeamAnalysisDb29Report = renderDatabaseTeamAnalysisDb29Report;
//# sourceMappingURL=team-analysis-db29-report.js.map