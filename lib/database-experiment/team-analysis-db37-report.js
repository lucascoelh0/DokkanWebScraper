...
exports.renderDatabaseTeamAnalysisDb37Report = void 0;
const rows = (values) => Object.entries(values).map(([value, count]) => `| \`${value}\` | ${count} |`).join("\n");
function renderDatabaseTeamAnalysisDb37Report(coverage) {
...
exports.renderDatabaseTeamAnalysisDb37Report = renderDatabaseTeamAnalysisDb37Report;
//# sourceMappingURL=team-analysis-db37-report.js.map