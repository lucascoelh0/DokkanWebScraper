...
exports.validateDatabaseTeamAnalysisDb33Dataset = void 0;
const team_analysis_db33_builder_1 = require("./team-analysis-db33-builder");
function validateDatabaseTeamAnalysisDb33Dataset(dataset, db32) {
    const failures = [];
    if (dataset.contract !== "dokkan-team-analysis-player-attack-setup-timing-experiment" || dataset.contractVersion !== "0.32.0" || dataset.sourceDb32.contractVersion !== "0.31.0")
        failures.push("contract identity");
    if (dataset.sourceDatabaseSha256 !== db32.sourceDatabaseSha256 || dataset.sourceSnapshotVersion !== db32.sourceSnapshotVersion || dataset.generatedAt !== db32.generatedAt || dataset.currentTeamAnalysis.sha256 !== db32.currentTeamAnalysis.sha256 || dataset.nativeRuntime.sha256 !== db32.nativeRuntime.sha256 || dataset.nativeRuntime.sizeBytes !== db32.nativeRuntime.sizeBytes)
