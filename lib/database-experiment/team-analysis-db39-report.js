...
exports.renderDatabaseTeamAnalysisDb39Report = void 0;
const rows = (values) => Object.entries(values).map(([key, value]) => `| \`${key}\` | ${value} |`).join("\n");
function renderDatabaseTeamAnalysisDb39Report(dataset, coverage) {
...
exports.renderDatabaseTeamAnalysisDb39Report = renderDatabaseTeamAnalysisDb39Report;
//# sourceMappingURL=team-analysis-db39-report.js.map