...
const team_analysis_db29_builder_1 = require("./team-analysis-db29-builder");
const team_analysis_db29_golden_1 = require("./team-analysis-db29-golden");
const team_analysis_db29_report_1 = require("./team-analysis-db29-report");
const team_analysis_db30_builder_1 = require("./team-analysis-db30-builder");
const team_analysis_db30_golden_1 = require("./team-analysis-db30-golden");
const team_analysis_db30_report_1 = require("./team-analysis-db30-report");
const team_analysis_db31_builder_1 = require("./team-analysis-db31-builder");
const team_analysis_db31_golden_1 = require("./team-analysis-db31-golden");
const team_analysis_db31_report_1 = require("./team-analysis-db31-report");
const team_analysis_db31_validator_1 = require("./team-analysis-db31-validator");
const team_analysis_db32_builder_1 = require("./team-analysis-db32-builder");
const team_analysis_db32_golden_1 = require("./team-analysis-db32-golden");
const team_analysis_db32_report_1 = require("./team-analysis-db32-report");
const team_analysis_db32_validator_1 = require("./team-analysis-db32-validator");
const team_analysis_db33_builder_1 = require("./team-analysis-db33-builder");
const team_analysis_db33_golden_1 = require("./team-analysis-db33-golden");
const team_analysis_db33_report_1 = require("./team-analysis-db33-report");
const team_analysis_db33_validator_1 = require("./team-analysis-db33-validator");
const team_analysis_db34_builder_1 = require("./team-analysis-db34-builder");
const team_analysis_db34_golden_1 = require("./team-analysis-db34-golden");
const team_analysis_db34_report_1 = require("./team-analysis-db34-report");
const team_analysis_db34_validator_1 = require("./team-analysis-db34-validator");
const team_analysis_db35_builder_1 = require("./team-analysis-db35-builder");
const team_analysis_db35_golden_1 = require("./team-analysis-db35-golden");
const team_analysis_db35_report_1 = require("./team-analysis-db35-report");
const team_analysis_db35_validator_1 = require("./team-analysis-db35-validator");
const team_analysis_db36_builder_1 = require("./team-analysis-db36-builder");
const team_analysis_db36_golden_1 = require("./team-analysis-db36-golden");
const team_analysis_db36_report_1 = require("./team-analysis-db36-report");
const team_analysis_db36_validator_1 = require("./team-analysis-db36-validator");
const team_analysis_db37_builder_1 = require("./team-analysis-db37-builder");
const team_analysis_db37_golden_1 = require("./team-analysis-db37-golden");
const team_analysis_db37_report_1 = require("./team-analysis-db37-report");
const team_analysis_db37_validator_1 = require("./team-analysis-db37-validator");
const team_analysis_db38_builder_1 = require("./team-analysis-db38-builder");
const team_analysis_db38_golden_1 = require("./team-analysis-db38-golden");
const team_analysis_db38_report_1 = require("./team-analysis-db38-report");
const team_analysis_db38_validator_1 = require("./team-analysis-db38-validator");
const team_analysis_db39_builder_1 = require("./team-analysis-db39-builder");
const team_analysis_db39_golden_1 = require("./team-analysis-db39-golden");
const team_analysis_db39_report_1 = require("./team-analysis-db39-report");
const team_analysis_db39_validator_1 = require("./team-analysis-db39-validator");
const team_analysis_db40_builder_1 = require("./team-analysis-db40-builder");
const team_analysis_db40_golden_1 = require("./team-analysis-db40-golden");
const team_analysis_db40_report_1 = require("./team-analysis-db40-report");
const team_analysis_db40_validator_1 = require("./team-analysis-db40-validator");
const team_analysis_db41_builder_1 = require("./team-analysis-db41-builder");
const team_analysis_db41_golden_1 = require("./team-analysis-db41-golden");
const team_analysis_db41_report_1 = require("./team-analysis-db41-report");
const team_analysis_db41_validator_1 = require("./team-analysis-db41-validator");
const team_analysis_db42_builder_1 = require("./team-analysis-db42-builder");
const team_analysis_db42_golden_1 = require("./team-analysis-db42-golden");
const team_analysis_db42_report_1 = require("./team-analysis-db42-report");
const team_analysis_db42_validator_1 = require("./team-analysis-db42-validator");
const team_analysis_db43_builder_1 = require("./team-analysis-db43-builder");
const team_analysis_db43_golden_1 = require("./team-analysis-db43-golden");
const team_analysis_db43_report_1 = require("./team-analysis-db43-report");
...
const team_analysis_db44_golden_1 = require("./team-analysis-db44-golden");
const team_analysis_db44_report_1 = require("./team-analysis-db44-report");
const team_analysis_db44_validator_1 = require("./team-analysis-db44-validator");
const team_analysis_db45_builder_1 = require("./team-analysis-db45-builder");
const team_analysis_db45_golden_1 = require("./team-analysis-db45-golden");
const team_analysis_db45_report_1 = require("./team-analysis-db45-report");
const team_analysis_db45_validator_1 = require("./team-analysis-db45-validator");
const team_analysis_db46_builder_1 = require("./team-analysis-db46-builder");
const team_analysis_db46_golden_1 = require("./team-analysis-db46-golden");
const team_analysis_db46_report_1 = require("./team-analysis-db46-report");
const team_analysis_db46_validator_1 = require("./team-analysis-db46-validator");
const team_analysis_db47_builder_1 = require("./team-analysis-db47-builder");
const team_analysis_db47_golden_1 = require("./team-analysis-db47-golden");
const team_analysis_db47_report_1 = require("./team-analysis-db47-report");
...
const team_analysis_db48_golden_1 = require("./team-analysis-db48-golden");
const team_analysis_db48_report_1 = require("./team-analysis-db48-report");
...
const team_analysis_db49_golden_1 = require("./team-analysis-db49-golden");
const team_analysis_db49_report_1 = require("./team-analysis-db49-report");
...
async function runDatabaseExperiment(options) {
    ...
    const lifecycleEvidencePath = (0, path_1.resolve)(__dirname, "native-appearance-turn-lifecycle.json");
    ...
    const nativeLinkageEvidencePath = (0, path_1.resolve)(__dirname, "native-passive-turn-linkage-audit.json");
    ...
    const counterEvidencePath = (0, path_1.resolve)(__dirname, "native-counter-behavior-semantics.json");
    ...
    const attackContextEvidencePath = (0, path_1.resolve)(__dirname, "native-attack-context-semantics.json");
    ...
    const specialCategoryEvidencePath = (0, path_1.resolve)(__dirname, "native-special-category-semantics.json");
    ...
    const targetHpEvidencePath = (0, path_1.resolve)(__dirname, "native-target-hp-semantics.json");
    ...
    const revivalCounterEvidencePath = (0, path_1.resolve)(__dirname, "native-revival-counter-semantics.json");
    ...
    const attackBreakEvidencePath = (0, path_1.resolve)(__dirname, "native-attack-break-semantics.json");
    const attackBreakEvidenceBytes = await (0, promises_1.readFile)(attackBreakEvidencePath);
    const attackBreakEvidence = JSON.parse(attackBreakEvidenceBytes.toString("utf8"));
    const attackBreakEvidenceSha256 = sha256(attackBreakEvidenceBytes);
    const buildTeamAnalysisDb29 = () => (0, team_analysis_db29_builder_1.buildDatabaseTeamAnalysisDb29Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: sha256(teamAnalysisDb8Gzip), db9: teamAnalysisDb9Dataset, db9Sha256: sha256(teamAnalysisDb9Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: attackBreakEvidence, evidenceSha256: attackBreakEvidenceSha256 });
    const teamAnalysisDb29Dataset = buildTeamAnalysisDb29();
    const firstTeamAnalysisDb29Json = `${JSON.stringify(teamAnalysisDb29Dataset)}\n`;
    ...
    if (sha256(firstTeamAnalysisDb29Json) !== sha256(secondTeamAnalysisDb29Json))
        throw new Error("DB29 determinism check failed: two attack-break projections differ");
    const teamAnalysisDb29Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb29Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb29Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb29Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb29Gzip.equals(secondTeamAnalysisDb29Gzip))
        throw new Error("DB29 determinism check failed: gzip bytes differ");
    const teamAnalysisDb29SourceGapRuleCount = teamAnalysisDb8Dataset.efficacyGaps.find(value => Number(value.efficacyType) === 111)?.ruleCount ?? 0;
    const teamAnalysisDb29Coverage = (0, team_analysis_db29_builder_1.buildDatabaseTeamAnalysisDb29Coverage)(teamAnalysisDb29Dataset, teamAnalysisDb29SourceGapRuleCount);
    const teamAnalysisDb29Goldens = await (0, team_analysis_db29_golden_1.validateDatabaseTeamAnalysisDb29Goldens)(teamAnalysisDb29Dataset, teamAnalysisDb29Coverage);
    if (teamAnalysisDb29Goldens.failures.length > 0)
        throw new Error(`DB29 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb29Goldens.failures)}`);
    const teamAnalysisDb29Report = (0, team_analysis_db29_report_1.renderDatabaseTeamAnalysisDb29Report)(teamAnalysisDb29Dataset, teamAnalysisDb29Coverage);
    const removalEvidencePath = (0, path_1.resolve)(__dirname, "native-efficacy-removal-semantics.json");
    const removalEvidenceBytes = await (0, promises_1.readFile)(removalEvidencePath);
    const removalEvidence = JSON.parse(removalEvidenceBytes.toString("utf8"));
    const removalEvidenceSha256 = sha256(removalEvidenceBytes);
    const buildTeamAnalysisDb30 = () => (0, team_analysis_db30_builder_1.buildDatabaseTeamAnalysisDb30Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: sha256(teamAnalysisDb8Gzip), db9: teamAnalysisDb9Dataset, db9Sha256: sha256(teamAnalysisDb9Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: removalEvidence, evidenceSha256: removalEvidenceSha256 });
    ...
    if (sha256(firstTeamAnalysisDb30Json) !== sha256(secondTeamAnalysisDb30Json))
        throw new Error("DB30 determinism check failed: two efficacy-removal projections differ");
    const teamAnalysisDb30Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb30Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb30Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb30Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb30Gzip.equals(secondTeamAnalysisDb30Gzip))
        throw new Error("DB30 determinism check failed: gzip bytes differ");
    const teamAnalysisDb30SourceGapRuleCount = teamAnalysisDb8Dataset.efficacyGaps.find(value => Number(value.efficacyType) === 110)?.ruleCount ?? 0;
    const teamAnalysisDb30Coverage = (0, team_analysis_db30_builder_1.buildDatabaseTeamAnalysisDb30Coverage)(teamAnalysisDb30Dataset, teamAnalysisDb30SourceGapRuleCount);
    const teamAnalysisDb30Goldens = await (0, team_analysis_db30_golden_1.validateDatabaseTeamAnalysisDb30Goldens)(teamAnalysisDb30Dataset, teamAnalysisDb30Coverage);
    if (teamAnalysisDb30Goldens.failures.length > 0)
        throw new Error(`DB30 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb30Goldens.failures)}`);
    const teamAnalysisDb30Report = (0, team_analysis_db30_report_1.renderDatabaseTeamAnalysisDb30Report)(teamAnalysisDb30Coverage);
    const calcOptionEvidencePath = (0, path_1.resolve)(__dirname, "native-skill-calc-option-semantics.json");
    const calcOptionEvidenceBytes = await (0, promises_1.readFile)(calcOptionEvidencePath);
    const calcOptionEvidence = JSON.parse(calcOptionEvidenceBytes.toString("utf8"));
    const calcOptionEvidenceSha256 = sha256(calcOptionEvidenceBytes);
    const buildTeamAnalysisDb31 = () => (0, team_analysis_db31_builder_1.buildDatabaseTeamAnalysisDb31Dataset)({ db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), current: currentTeamAnalysis.dataset, currentSha256: currentTeamAnalysis.sha256, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: calcOptionEvidence, evidenceSha256: calcOptionEvidenceSha256 });
    const teamAnalysisDb31Dataset = buildTeamAnalysisDb31();
    const firstTeamAnalysisDb31Json = `${JSON.stringify(teamAnalysisDb31Dataset)}\n`;
    ...
    if (sha256(firstTeamAnalysisDb31Json) !== sha256(secondTeamAnalysisDb31Json))
        throw new Error("DB31 determinism check failed: two SkillCalcOption projections differ");
    const teamAnalysisDb31Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb31Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb31Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb31Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb31Gzip.equals(secondTeamAnalysisDb31Gzip))
        throw new Error("DB31 determinism check failed: gzip bytes differ");
    const teamAnalysisDb31Validation = (0, team_analysis_db31_validator_1.validateDatabaseTeamAnalysisDb31Dataset)(teamAnalysisDb31Dataset, teamAnalysisDb11Dataset);
    if (!teamAnalysisDb31Validation.valid)
        throw new Error(`DB31 payload validation failed: ${JSON.stringify(teamAnalysisDb31Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb31Coverage = (0, team_analysis_db31_builder_1.buildDatabaseTeamAnalysisDb31Coverage)(teamAnalysisDb31Dataset);
    const teamAnalysisDb31Goldens = await (0, team_analysis_db31_golden_1.validateDatabaseTeamAnalysisDb31Goldens)(teamAnalysisDb31Dataset, teamAnalysisDb31Coverage);
    if (teamAnalysisDb31Goldens.failures.length > 0)
        throw new Error(`DB31 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb31Goldens.failures)}`);
    const teamAnalysisDb31Report = (0, team_analysis_db31_report_1.renderDatabaseTeamAnalysisDb31Report)(teamAnalysisDb31Coverage);
    const executionTimingEvidencePath = (0, path_1.resolve)(__dirname, "native-execution-timing-semantics.json");
    const executionTimingEvidenceBytes = await (0, promises_1.readFile)(executionTimingEvidencePath);
    const executionTimingEvidence = JSON.parse(executionTimingEvidenceBytes.toString("utf8"));
    const executionTimingEvidenceSha256 = sha256(executionTimingEvidenceBytes);
    const buildTeamAnalysisDb32 = () => (0, team_analysis_db32_builder_1.buildDatabaseTeamAnalysisDb32Dataset)({ db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), db31: teamAnalysisDb31Dataset, db31Sha256: sha256(teamAnalysisDb31Gzip), current: currentTeamAnalysis.dataset, currentSha256: currentTeamAnalysis.sha256, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: executionTimingEvidence, evidenceSha256: executionTimingEvidenceSha256 });
    const teamAnalysisDb32Dataset = buildTeamAnalysisDb32();
    const firstTeamAnalysisDb32Json = `${JSON.stringify(teamAnalysisDb32Dataset)}\n`;
    const secondTeamAnalysisDb32Json = `${JSON.stringify(buildTeamAnalysisDb32())}\n`;
    if (sha256(firstTeamAnalysisDb32Json) !== sha256(secondTeamAnalysisDb32Json))
        throw new Error("DB32 determinism check failed: two execution-timing projections differ");
    const teamAnalysisDb32Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb32Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb32Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb32Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb32Gzip.equals(secondTeamAnalysisDb32Gzip))
        throw new Error("DB32 determinism check failed: gzip bytes differ");
    const teamAnalysisDb32Validation = (0, team_analysis_db32_validator_1.validateDatabaseTeamAnalysisDb32Dataset)(teamAnalysisDb32Dataset, teamAnalysisDb11Dataset, teamAnalysisDb31Dataset);
    if (!teamAnalysisDb32Validation.valid)
        throw new Error(`DB32 payload validation failed: ${JSON.stringify(teamAnalysisDb32Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb32Coverage = (0, team_analysis_db32_builder_1.buildDatabaseTeamAnalysisDb32Coverage)(teamAnalysisDb32Dataset);
    const teamAnalysisDb32Goldens = await (0, team_analysis_db32_golden_1.validateDatabaseTeamAnalysisDb32Goldens)(teamAnalysisDb32Dataset, teamAnalysisDb32Coverage);
    if (teamAnalysisDb32Goldens.failures.length > 0)
        throw new Error(`DB32 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb32Goldens.failures)}`);
    const teamAnalysisDb32Report = (0, team_analysis_db32_report_1.renderDatabaseTeamAnalysisDb32Report)(teamAnalysisDb32Coverage);
    const attackSetupTimingEvidencePath = (0, path_1.resolve)(__dirname, "native-execution-timing-value-4-semantics.json");
    const attackSetupTimingEvidenceBytes = await (0, promises_1.readFile)(attackSetupTimingEvidencePath);
    const attackSetupTimingEvidence = JSON.parse(attackSetupTimingEvidenceBytes.toString("utf8"));
    const attackSetupTimingEvidenceSha256 = sha256(attackSetupTimingEvidenceBytes);
    const buildTeamAnalysisDb33 = () => (0, team_analysis_db33_builder_1.buildDatabaseTeamAnalysisDb33Dataset)({ db32: teamAnalysisDb32Dataset, db32Sha256: sha256(teamAnalysisDb32Gzip), sourceDatabaseSha256: before.sha256, current: currentTeamAnalysis.dataset, currentSha256: currentTeamAnalysis.sha256, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: attackSetupTimingEvidence, evidenceSha256: attackSetupTimingEvidenceSha256 });
    const teamAnalysisDb33Dataset = buildTeamAnalysisDb33();
    const firstTeamAnalysisDb33Json = `${JSON.stringify(teamAnalysisDb33Dataset)}\n`;
    ...
    if (sha256(firstTeamAnalysisDb33Json) !== sha256(secondTeamAnalysisDb33Json))
        throw new Error("DB33 determinism check failed: two player-attack-setup timing projections differ");
    const teamAnalysisDb33Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb33Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb33Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb33Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb33Gzip.equals(secondTeamAnalysisDb33Gzip))
        throw new Error("DB33 determinism check failed: gzip bytes differ");
    const teamAnalysisDb33Validation = (0, team_analysis_db33_validator_1.validateDatabaseTeamAnalysisDb33Dataset)(teamAnalysisDb33Dataset, teamAnalysisDb32Dataset);
    if (!teamAnalysisDb33Validation.valid)
        throw new Error(`DB33 payload validation failed: ${JSON.stringify(teamAnalysisDb33Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb33Coverage = (0, team_analysis_db33_builder_1.buildDatabaseTeamAnalysisDb33Coverage)(teamAnalysisDb33Dataset);
    const teamAnalysisDb33Goldens = await (0, team_analysis_db33_golden_1.validateDatabaseTeamAnalysisDb33Goldens)(teamAnalysisDb33Dataset, teamAnalysisDb33Coverage);
    if (teamAnalysisDb33Goldens.failures.length > 0)
        throw new Error(`DB33 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb33Goldens.failures)}`);
    const teamAnalysisDb33Report = (0, team_analysis_db33_report_1.renderDatabaseTeamAnalysisDb33Report)(teamAnalysisDb33Coverage);
    const basicStatBucketEvidencePath = (0, path_1.resolve)(__dirname, "native-basic-stat-bucket-semantics.json");
    const basicStatBucketEvidenceBytes = await (0, promises_1.readFile)(basicStatBucketEvidencePath);
    const basicStatBucketEvidence = JSON.parse(basicStatBucketEvidenceBytes.toString("utf8"));
    const basicStatBucketEvidenceSha256 = sha256(basicStatBucketEvidenceBytes);
    const buildTeamAnalysisDb34 = () => (0, team_analysis_db34_builder_1.buildDatabaseTeamAnalysisDb34Dataset)({ db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), db13: teamAnalysisDb13Dataset, db13Sha256: sha256(teamAnalysisDb13Gzip), db31: teamAnalysisDb31Dataset, db31Sha256: sha256(teamAnalysisDb31Gzip), db33: teamAnalysisDb33Dataset, db33Sha256: sha256(teamAnalysisDb33Gzip), tables, current: currentTeamAnalysis.dataset, currentSha256: currentTeamAnalysis.sha256, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: basicStatBucketEvidence, evidenceSha256: basicStatBucketEvidenceSha256 });
    const teamAnalysisDb34Dataset = buildTeamAnalysisDb34();
    const firstTeamAnalysisDb34Json = `${JSON.stringify(teamAnalysisDb34Dataset)}\n`;
    const secondTeamAnalysisDb34Json = `${JSON.stringify(buildTeamAnalysisDb34())}\n`;
    if (sha256(firstTeamAnalysisDb34Json) !== sha256(secondTeamAnalysisDb34Json))
        throw new Error("DB34 determinism check failed: two basic-stat bucket projections differ");
    const teamAnalysisDb34Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb34Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb34Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb34Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb34Gzip.equals(secondTeamAnalysisDb34Gzip))
        throw new Error("DB34 determinism check failed: gzip bytes differ");
    const teamAnalysisDb34Validation = (0, team_analysis_db34_validator_1.validateDatabaseTeamAnalysisDb34Dataset)(teamAnalysisDb34Dataset, teamAnalysisDb11Dataset, teamAnalysisDb31Dataset, teamAnalysisDb33Dataset, tables);
    if (!teamAnalysisDb34Validation.valid)
        throw new Error(`DB34 payload validation failed: ${JSON.stringify(teamAnalysisDb34Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb34Coverage = (0, team_analysis_db34_builder_1.buildDatabaseTeamAnalysisDb34Coverage)(teamAnalysisDb34Dataset);
    const teamAnalysisDb34Goldens = await (0, team_analysis_db34_golden_1.validateDatabaseTeamAnalysisDb34Goldens)(teamAnalysisDb34Dataset, teamAnalysisDb34Coverage);
    if (teamAnalysisDb34Goldens.failures.length > 0)
        throw new Error(`DB34 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb34Goldens.failures)}`);
    const teamAnalysisDb34Report = (0, team_analysis_db34_report_1.renderDatabaseTeamAnalysisDb34Report)(teamAnalysisDb34Dataset, teamAnalysisDb34Coverage);
    const passiveTargetEvidencePath = (0, path_1.resolve)(__dirname, "native-passive-target-dispatch-semantics.json");
    const passiveTargetEvidenceBytes = await (0, promises_1.readFile)(passiveTargetEvidencePath);
    const passiveTargetEvidence = JSON.parse(passiveTargetEvidenceBytes.toString("utf8"));
    const passiveTargetEvidenceSha256 = sha256(passiveTargetEvidenceBytes);
    const buildTeamAnalysisDb35 = () => (0, team_analysis_db35_builder_1.buildDatabaseTeamAnalysisDb35Dataset)({ db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), db33: teamAnalysisDb33Dataset, db33Sha256: sha256(teamAnalysisDb33Gzip), tables, current: currentTeamAnalysis.dataset, currentSha256: currentTeamAnalysis.sha256, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: passiveTargetEvidence, evidenceSha256: passiveTargetEvidenceSha256 });
    const teamAnalysisDb35Dataset = buildTeamAnalysisDb35();
    ...
    if (sha256(firstTeamAnalysisDb35Json) !== sha256(secondTeamAnalysisDb35Json))
        throw new Error("DB35 determinism check failed: two target projections differ");
    const teamAnalysisDb35Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb35Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb35Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb35Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb35Gzip.equals(secondTeamAnalysisDb35Gzip))
        throw new Error("DB35 determinism check failed: gzip bytes differ");
    const teamAnalysisDb35Validation = (0, team_analysis_db35_validator_1.validateDatabaseTeamAnalysisDb35Dataset)(teamAnalysisDb35Dataset, teamAnalysisDb11Dataset, tables, { db11Sha256: sha256(teamAnalysisDb11Gzip), db33: teamAnalysisDb33Dataset, db33Sha256: sha256(teamAnalysisDb33Gzip), current: currentTeamAnalysis.dataset, currentSha256: currentTeamAnalysis.sha256, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: passiveTargetEvidence, evidenceSha256: passiveTargetEvidenceSha256 });
    if (!teamAnalysisDb35Validation.valid)
        throw new Error(`DB35 payload validation failed: ${JSON.stringify(teamAnalysisDb35Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb35Coverage = (0, team_analysis_db35_builder_1.buildDatabaseTeamAnalysisDb35Coverage)(teamAnalysisDb35Dataset);
    const teamAnalysisDb35Goldens = await (0, team_analysis_db35_golden_1.validateDatabaseTeamAnalysisDb35Goldens)(teamAnalysisDb35Dataset, teamAnalysisDb35Coverage);
    if (teamAnalysisDb35Goldens.failures.length > 0)
        throw new Error(`DB35 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb35Goldens.failures)}`);
    const teamAnalysisDb35Report = (0, team_analysis_db35_report_1.renderDatabaseTeamAnalysisDb35Report)(teamAnalysisDb35Dataset, teamAnalysisDb35Coverage);
    const subTargetEvidencePath = (0, path_1.resolve)(__dirname, "native-sub-target-type-semantics.json");
    const subTargetEvidenceBytes = await (0, promises_1.readFile)(subTargetEvidencePath);
    const subTargetEvidence = JSON.parse(subTargetEvidenceBytes.toString("utf8"));
    const subTargetEvidenceSha256 = sha256(subTargetEvidenceBytes);
    const buildTeamAnalysisDb36 = () => (0, team_analysis_db36_builder_1.buildDatabaseTeamAnalysisDb36Dataset)({ db35: teamAnalysisDb35Dataset, db35Sha256: sha256(teamAnalysisDb35Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: subTargetEvidence, evidenceSha256: subTargetEvidenceSha256 });
    const teamAnalysisDb36Dataset = buildTeamAnalysisDb36();
    ...
    if (sha256(firstTeamAnalysisDb36Json) !== sha256(secondTeamAnalysisDb36Json))
        throw new Error("DB36 determinism check failed: two sub-target projections differ");
    const teamAnalysisDb36Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb36Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb36Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb36Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb36Gzip.equals(secondTeamAnalysisDb36Gzip))
        throw new Error("DB36 determinism check failed: gzip bytes differ");
    const teamAnalysisDb36Validation = (0, team_analysis_db36_validator_1.validateDatabaseTeamAnalysisDb36Dataset)(teamAnalysisDb36Dataset, teamAnalysisDb35Dataset, tables, { db35Sha256: sha256(teamAnalysisDb35Gzip), nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: subTargetEvidence, evidenceSha256: subTargetEvidenceSha256 });
    if (!teamAnalysisDb36Validation.valid)
        throw new Error(`DB36 payload validation failed: ${JSON.stringify(teamAnalysisDb36Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb36Coverage = (0, team_analysis_db36_builder_1.buildDatabaseTeamAnalysisDb36Coverage)(teamAnalysisDb36Dataset);
    const teamAnalysisDb36Goldens = await (0, team_analysis_db36_golden_1.validateDatabaseTeamAnalysisDb36Goldens)(teamAnalysisDb36Dataset, teamAnalysisDb36Coverage);
    if (teamAnalysisDb36Goldens.failures.length > 0)
        throw new Error(`DB36 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb36Goldens.failures)}`);
    const teamAnalysisDb36Report = (0, team_analysis_db36_report_1.renderDatabaseTeamAnalysisDb36Report)(teamAnalysisDb36Coverage);
    const passiveLifecycleEvidencePath = (0, path_1.resolve)(__dirname, "native-passive-lifecycle-semantics.json");
    const passiveLifecycleEvidenceBytes = await (0, promises_1.readFile)(passiveLifecycleEvidencePath);
    const passiveLifecycleEvidence = JSON.parse(passiveLifecycleEvidenceBytes.toString("utf8"));
    const passiveLifecycleEvidenceSha256 = sha256(passiveLifecycleEvidenceBytes);
    const buildTeamAnalysisDb37 = () => (0, team_analysis_db37_builder_1.buildDatabaseTeamAnalysisDb37Dataset)({ db36: teamAnalysisDb36Dataset, db36Sha256: sha256(teamAnalysisDb36Gzip), db20: teamAnalysisDb20Dataset, db20Sha256: sha256(teamAnalysisDb20Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: passiveLifecycleEvidence, evidenceSha256: passiveLifecycleEvidenceSha256 });
    const teamAnalysisDb37Dataset = buildTeamAnalysisDb37();
    const firstTeamAnalysisDb37Json = `${JSON.stringify(teamAnalysisDb37Dataset)}\n`;
    ...
    if (sha256(firstTeamAnalysisDb37Json) !== sha256(secondTeamAnalysisDb37Json))
        throw new Error("DB37 determinism check failed: two passive lifecycle projections differ");
    const teamAnalysisDb37Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb37Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb37Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb37Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb37Gzip.equals(secondTeamAnalysisDb37Gzip))
        throw new Error("DB37 determinism check failed: gzip bytes differ");
    const teamAnalysisDb37Validation = (0, team_analysis_db37_validator_1.validateDatabaseTeamAnalysisDb37Dataset)(teamAnalysisDb37Dataset, teamAnalysisDb36Dataset, teamAnalysisDb20Dataset, tables, { db36Sha256: sha256(teamAnalysisDb36Gzip), db20Sha256: sha256(teamAnalysisDb20Gzip), nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: passiveLifecycleEvidence, evidenceSha256: passiveLifecycleEvidenceSha256 });
    if (!teamAnalysisDb37Validation.valid)
        throw new Error(`DB37 payload validation failed: ${JSON.stringify(teamAnalysisDb37Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb37Coverage = (0, team_analysis_db37_builder_1.buildDatabaseTeamAnalysisDb37Coverage)(teamAnalysisDb37Dataset);
    const teamAnalysisDb37Goldens = await (0, team_analysis_db37_golden_1.validateDatabaseTeamAnalysisDb37Goldens)(teamAnalysisDb37Dataset, teamAnalysisDb37Coverage);
    if (teamAnalysisDb37Goldens.failures.length > 0)
        throw new Error(`DB37 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb37Goldens.failures)}`);
    const teamAnalysisDb37Report = (0, team_analysis_db37_report_1.renderDatabaseTeamAnalysisDb37Report)(teamAnalysisDb37Coverage);
    const incrementalStatusEvidencePath = (0, path_1.resolve)(__dirname, "native-incremental-status-semantics.json");
    const incrementalStatusEvidenceBytes = await (0, promises_1.readFile)(incrementalStatusEvidencePath);
    const incrementalStatusEvidence = JSON.parse(incrementalStatusEvidenceBytes.toString("utf8"));
    const incrementalStatusEvidenceSha256 = sha256(incrementalStatusEvidenceBytes);
    const buildTeamAnalysisDb38 = () => (0, team_analysis_db38_builder_1.buildDatabaseTeamAnalysisDb38Dataset)({ db37: teamAnalysisDb37Dataset, db37Sha256: sha256(teamAnalysisDb37Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: incrementalStatusEvidence, evidenceSha256: incrementalStatusEvidenceSha256 });
    const teamAnalysisDb38Dataset = buildTeamAnalysisDb38();
    const firstTeamAnalysisDb38Json = `${JSON.stringify(teamAnalysisDb38Dataset)}\n`;
    const secondTeamAnalysisDb38Json = `${JSON.stringify(buildTeamAnalysisDb38())}\n`;
    if (sha256(firstTeamAnalysisDb38Json) !== sha256(secondTeamAnalysisDb38Json))
        throw new Error("DB38 determinism check failed: two incremental-status projections differ");
    const teamAnalysisDb38Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb38Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb38Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb38Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb38Gzip.equals(secondTeamAnalysisDb38Gzip))
        throw new Error("DB38 determinism check failed: gzip bytes differ");
    const teamAnalysisDb38Validation = (0, team_analysis_db38_validator_1.validateDatabaseTeamAnalysisDb38Dataset)(teamAnalysisDb38Dataset, teamAnalysisDb37Dataset, teamAnalysisDb11Dataset, tables, { db37Sha256: sha256(teamAnalysisDb37Gzip), db11Sha256: sha256(teamAnalysisDb11Gzip), nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: incrementalStatusEvidence, evidenceSha256: incrementalStatusEvidenceSha256 });
    if (!teamAnalysisDb38Validation.valid)
        throw new Error(`DB38 payload validation failed: ${JSON.stringify(teamAnalysisDb38Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb38Coverage = (0, team_analysis_db38_builder_1.buildDatabaseTeamAnalysisDb38Coverage)(teamAnalysisDb38Dataset);
    const teamAnalysisDb38Goldens = await (0, team_analysis_db38_golden_1.validateDatabaseTeamAnalysisDb38Goldens)(teamAnalysisDb38Dataset, teamAnalysisDb38Coverage);
    if (teamAnalysisDb38Goldens.failures.length > 0)
        throw new Error(`DB38 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb38Goldens.failures)}`);
    const teamAnalysisDb38Report = (0, team_analysis_db38_report_1.renderDatabaseTeamAnalysisDb38Report)(teamAnalysisDb38Dataset, teamAnalysisDb38Coverage);
    const proportionalStatEvidencePath = (0, path_1.resolve)(__dirname, "native-energy-ball-proportional-stat-semantics.json");
    const proportionalStatEvidenceBytes = await (0, promises_1.readFile)(proportionalStatEvidencePath);
    const proportionalStatEvidence = JSON.parse(proportionalStatEvidenceBytes.toString("utf8"));
    const proportionalStatEvidenceSha256 = sha256(proportionalStatEvidenceBytes);
    const buildTeamAnalysisDb39 = () => (0, team_analysis_db39_builder_1.buildDatabaseTeamAnalysisDb39Dataset)({ db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), db31: teamAnalysisDb31Dataset, db31Sha256: sha256(teamAnalysisDb31Gzip), db34: teamAnalysisDb34Dataset, db34Sha256: sha256(teamAnalysisDb34Gzip), db37: teamAnalysisDb37Dataset, db37Sha256: sha256(teamAnalysisDb37Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: proportionalStatEvidence, evidenceSha256: proportionalStatEvidenceSha256 });
    const teamAnalysisDb39Dataset = buildTeamAnalysisDb39();
    const firstTeamAnalysisDb39Json = `${JSON.stringify(teamAnalysisDb39Dataset)}\n`;
    const secondTeamAnalysisDb39Json = `${JSON.stringify(buildTeamAnalysisDb39())}\n`;
    if (sha256(firstTeamAnalysisDb39Json) !== sha256(secondTeamAnalysisDb39Json))
        throw new Error("DB39 determinism check failed: two proportional-stat projections differ");
    const teamAnalysisDb39Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb39Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb39Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb39Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb39Gzip.equals(secondTeamAnalysisDb39Gzip))
        throw new Error("DB39 determinism check failed: gzip bytes differ");
    const teamAnalysisDb39Validation = (0, team_analysis_db39_validator_1.validateDatabaseTeamAnalysisDb39Dataset)(teamAnalysisDb39Dataset, teamAnalysisDb11Dataset, teamAnalysisDb31Dataset, teamAnalysisDb37Dataset, tables, { db11Sha256: sha256(teamAnalysisDb11Gzip), db31Sha256: sha256(teamAnalysisDb31Gzip), db34Sha256: sha256(teamAnalysisDb34Gzip), db37Sha256: sha256(teamAnalysisDb37Gzip), nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: proportionalStatEvidence, evidenceSha256: proportionalStatEvidenceSha256 });
    if (!teamAnalysisDb39Validation.valid)
        throw new Error(`DB39 payload validation failed: ${JSON.stringify(teamAnalysisDb39Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb39Coverage = (0, team_analysis_db39_builder_1.buildDatabaseTeamAnalysisDb39Coverage)(teamAnalysisDb39Dataset);
    const teamAnalysisDb39Goldens = await (0, team_analysis_db39_golden_1.validateDatabaseTeamAnalysisDb39Goldens)(teamAnalysisDb39Dataset, teamAnalysisDb39Coverage);
    if (teamAnalysisDb39Goldens.failures.length > 0)
        throw new Error(`DB39 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb39Goldens.failures)}`);
    const teamAnalysisDb39Report = (0, team_analysis_db39_report_1.renderDatabaseTeamAnalysisDb39Report)(teamAnalysisDb39Dataset, teamAnalysisDb39Coverage);
    const battleGaugeThresholdEvidencePath = (0, path_1.resolve)(__dirname, "native-battle-gauge-threshold-semantics.json");
    const battleGaugeThresholdEvidenceBytes = await (0, promises_1.readFile)(battleGaugeThresholdEvidencePath);
    const battleGaugeThresholdEvidence = JSON.parse(battleGaugeThresholdEvidenceBytes.toString("utf8"));
    const battleGaugeThresholdEvidenceSha256 = sha256(battleGaugeThresholdEvidenceBytes);
    const buildTeamAnalysisDb40 = () => (0, team_analysis_db40_builder_1.buildDatabaseTeamAnalysisDb40Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: sha256(teamAnalysisDb8Gzip), db9: teamAnalysisDb9Dataset, db9Sha256: sha256(teamAnalysisDb9Gzip), db10: teamAnalysisDb10Dataset, db10Sha256: sha256(teamAnalysisDb10Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: battleGaugeThresholdEvidence, evidenceSha256: battleGaugeThresholdEvidenceSha256 });
    const teamAnalysisDb40Dataset = buildTeamAnalysisDb40();
    const firstTeamAnalysisDb40Json = `${JSON.stringify(teamAnalysisDb40Dataset)}\n`;
    const secondTeamAnalysisDb40Json = `${JSON.stringify(buildTeamAnalysisDb40())}\n`;
    if (sha256(firstTeamAnalysisDb40Json) !== sha256(secondTeamAnalysisDb40Json))
        throw new Error("DB40 determinism check failed: two battle-gauge threshold projections differ");
    const teamAnalysisDb40Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb40Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb40Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb40Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb40Gzip.equals(secondTeamAnalysisDb40Gzip))
        throw new Error("DB40 determinism check failed: gzip bytes differ");
    const teamAnalysisDb40Validation = (0, team_analysis_db40_validator_1.validateDatabaseTeamAnalysisDb40Dataset)(teamAnalysisDb40Dataset, teamAnalysisDb11Dataset, tables, { db8Sha256: sha256(teamAnalysisDb8Gzip), db9Sha256: sha256(teamAnalysisDb9Gzip), db10Sha256: sha256(teamAnalysisDb10Gzip), db11Sha256: sha256(teamAnalysisDb11Gzip), nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: battleGaugeThresholdEvidence, evidenceSha256: battleGaugeThresholdEvidenceSha256 });
    if (!teamAnalysisDb40Validation.valid)
        throw new Error(`DB40 payload validation failed: ${JSON.stringify(teamAnalysisDb40Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb40Coverage = (0, team_analysis_db40_builder_1.buildDatabaseTeamAnalysisDb40Coverage)(teamAnalysisDb40Dataset);
    const teamAnalysisDb40Goldens = await (0, team_analysis_db40_golden_1.validateDatabaseTeamAnalysisDb40Goldens)(teamAnalysisDb40Dataset, teamAnalysisDb40Coverage);
    if (teamAnalysisDb40Goldens.failures.length > 0)
        throw new Error(`DB40 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb40Goldens.failures)}`);
    const teamAnalysisDb40Report = (0, team_analysis_db40_report_1.renderDatabaseTeamAnalysisDb40Report)(teamAnalysisDb40Dataset, teamAnalysisDb40Coverage);
    const enemyCategoryCountEvidencePath = (0, path_1.resolve)(__dirname, "native-enemy-category-count-threshold-semantics.json");
    const enemyCategoryCountEvidenceBytes = await (0, promises_1.readFile)(enemyCategoryCountEvidencePath);
    const enemyCategoryCountEvidence = JSON.parse(enemyCategoryCountEvidenceBytes.toString("utf8"));
    const enemyCategoryCountEvidenceSha256 = sha256(enemyCategoryCountEvidenceBytes);
    const buildTeamAnalysisDb41 = () => (0, team_analysis_db41_builder_1.buildDatabaseTeamAnalysisDb41Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: sha256(teamAnalysisDb8Gzip), db9: teamAnalysisDb9Dataset, db9Sha256: sha256(teamAnalysisDb9Gzip), db10: teamAnalysisDb10Dataset, db10Sha256: sha256(teamAnalysisDb10Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: enemyCategoryCountEvidence, evidenceSha256: enemyCategoryCountEvidenceSha256 });
    const teamAnalysisDb41Dataset = buildTeamAnalysisDb41();
    const firstTeamAnalysisDb41Json = `${JSON.stringify(teamAnalysisDb41Dataset)}\n`;
    ...
    if (sha256(firstTeamAnalysisDb41Json) !== sha256(secondTeamAnalysisDb41Json))
        throw new Error("DB41 determinism check failed: two enemy-category count projections differ");
    const teamAnalysisDb41Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb41Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb41Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb41Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb41Gzip.equals(secondTeamAnalysisDb41Gzip))
        throw new Error("DB41 determinism check failed: gzip bytes differ");
    const teamAnalysisDb41Validation = (0, team_analysis_db41_validator_1.validateDatabaseTeamAnalysisDb41Dataset)(teamAnalysisDb41Dataset, teamAnalysisDb11Dataset, tables, { db8Sha256: sha256(teamAnalysisDb8Gzip), db9Sha256: sha256(teamAnalysisDb9Gzip), db10Sha256: sha256(teamAnalysisDb10Gzip), db11Sha256: sha256(teamAnalysisDb11Gzip), nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: enemyCategoryCountEvidence, evidenceSha256: enemyCategoryCountEvidenceSha256 });
    if (!teamAnalysisDb41Validation.valid)
        throw new Error(`DB41 payload validation failed: ${JSON.stringify(teamAnalysisDb41Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb41Coverage = (0, team_analysis_db41_builder_1.buildDatabaseTeamAnalysisDb41Coverage)(teamAnalysisDb41Dataset);
    const teamAnalysisDb41Goldens = await (0, team_analysis_db41_golden_1.validateDatabaseTeamAnalysisDb41Goldens)(teamAnalysisDb41Dataset, teamAnalysisDb41Coverage);
    if (teamAnalysisDb41Goldens.failures.length > 0)
        throw new Error(`DB41 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb41Goldens.failures)}`);
    const teamAnalysisDb41Report = (0, team_analysis_db41_report_1.renderDatabaseTeamAnalysisDb41Report)(teamAnalysisDb41Dataset, teamAnalysisDb41Coverage);
    const allTeamMemberEvidencePath = (0, path_1.resolve)(__dirname, "native-all-team-member-condition-semantics.json");
    const allTeamMemberEvidenceBytes = await (0, promises_1.readFile)(allTeamMemberEvidencePath);
    const allTeamMemberEvidence = JSON.parse(allTeamMemberEvidenceBytes.toString("utf8"));
    const allTeamMemberEvidenceSha256 = sha256(allTeamMemberEvidenceBytes);
    const buildTeamAnalysisDb42 = () => (0, team_analysis_db42_builder_1.buildDatabaseTeamAnalysisDb42Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: sha256(teamAnalysisDb8Gzip), db9: teamAnalysisDb9Dataset, db9Sha256: sha256(teamAnalysisDb9Gzip), db10: teamAnalysisDb10Dataset, db10Sha256: sha256(teamAnalysisDb10Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: allTeamMemberEvidence, evidenceSha256: allTeamMemberEvidenceSha256, classEvidenceSha256: passiveTargetEvidenceSha256 });
    const teamAnalysisDb42Dataset = buildTeamAnalysisDb42();
    const firstTeamAnalysisDb42Json = `${JSON.stringify(teamAnalysisDb42Dataset)}\n`;
    const secondTeamAnalysisDb42Json = `${JSON.stringify(buildTeamAnalysisDb42())}\n`;
    if (sha256(firstTeamAnalysisDb42Json) !== sha256(secondTeamAnalysisDb42Json))
        throw new Error("DB42 determinism check failed: two all-team-member projections differ");
    const teamAnalysisDb42Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb42Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb42Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb42Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb42Gzip.equals(secondTeamAnalysisDb42Gzip))
        throw new Error("DB42 determinism check failed: gzip bytes differ");
    const teamAnalysisDb42Validation = (0, team_analysis_db42_validator_1.validateDatabaseTeamAnalysisDb42Dataset)(teamAnalysisDb42Dataset, teamAnalysisDb11Dataset, tables, { db8Sha256: sha256(teamAnalysisDb8Gzip), db9Sha256: sha256(teamAnalysisDb9Gzip), db10Sha256: sha256(teamAnalysisDb10Gzip), db11Sha256: sha256(teamAnalysisDb11Gzip), nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: allTeamMemberEvidence, evidenceSha256: allTeamMemberEvidenceSha256, classEvidenceSha256: passiveTargetEvidenceSha256 });
    if (!teamAnalysisDb42Validation.valid)
        throw new Error(`DB42 payload validation failed: ${JSON.stringify(teamAnalysisDb42Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb42Coverage = (0, team_analysis_db42_builder_1.buildDatabaseTeamAnalysisDb42Coverage)(teamAnalysisDb42Dataset);
    const teamAnalysisDb42Goldens = await (0, team_analysis_db42_golden_1.validateDatabaseTeamAnalysisDb42Goldens)(teamAnalysisDb42Dataset, teamAnalysisDb42Coverage);
    if (teamAnalysisDb42Goldens.failures.length > 0)
        throw new Error(`DB42 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb42Goldens.failures)}`);
    const teamAnalysisDb42Report = (0, team_analysis_db42_report_1.renderDatabaseTeamAnalysisDb42Report)(teamAnalysisDb42Dataset, teamAnalysisDb42Coverage);
    const guardDisableEvidencePath = (0, path_1.resolve)(__dirname, "native-guard-disable-semantics.json");
    const guardDisableEvidenceBytes = await (0, promises_1.readFile)(guardDisableEvidencePath);
    const guardDisableEvidence = JSON.parse(guardDisableEvidenceBytes.toString("utf8"));
    const guardDisableEvidenceSha256 = sha256(guardDisableEvidenceBytes);
    const buildTeamAnalysisDb43 = () => (0, team_analysis_db43_builder_1.buildDatabaseTeamAnalysisDb43Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: sha256(teamAnalysisDb8Gzip), db9: teamAnalysisDb9Dataset, db9Sha256: sha256(teamAnalysisDb9Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), db33: teamAnalysisDb33Dataset, db33Sha256: sha256(teamAnalysisDb33Gzip), db35: teamAnalysisDb35Dataset, db35Sha256: sha256(teamAnalysisDb35Gzip), db36: teamAnalysisDb36Dataset, db36Sha256: sha256(teamAnalysisDb36Gzip), db37: teamAnalysisDb37Dataset, db37Sha256: sha256(teamAnalysisDb37Gzip), tables, current: currentTeamAnalysis.dataset, currentSha256: currentTeamAnalysis.sha256, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: guardDisableEvidence, evidenceSha256: guardDisableEvidenceSha256 });
    const teamAnalysisDb43Dataset = buildTeamAnalysisDb43();
    ...
    if (sha256(firstTeamAnalysisDb43Json) !== sha256(secondTeamAnalysisDb43Json))
        throw new Error("DB43 determinism check failed: two guard-disable projections differ");
    const teamAnalysisDb43Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb43Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb43Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb43Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb43Gzip.equals(secondTeamAnalysisDb43Gzip))
        throw new Error("DB43 determinism check failed: gzip bytes differ");
    const teamAnalysisDb43Validation = (0, team_analysis_db43_validator_1.validateDatabaseTeamAnalysisDb43Dataset)(teamAnalysisDb43Dataset, teamAnalysisDb11Dataset, teamAnalysisDb33Dataset, teamAnalysisDb35Dataset, teamAnalysisDb36Dataset, teamAnalysisDb37Dataset, tables, { db8Sha256: sha256(teamAnalysisDb8Gzip), db9Sha256: sha256(teamAnalysisDb9Gzip), db11Sha256: sha256(teamAnalysisDb11Gzip), db33Sha256: sha256(teamAnalysisDb33Gzip), db35Sha256: sha256(teamAnalysisDb35Gzip), db36Sha256: sha256(teamAnalysisDb36Gzip), db37Sha256: sha256(teamAnalysisDb37Gzip), currentTeamAnalysisSha256: currentTeamAnalysis.sha256, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: guardDisableEvidence, evidenceSha256: guardDisableEvidenceSha256 });
    if (!teamAnalysisDb43Validation.valid)
        throw new Error(`DB43 payload validation failed: ${JSON.stringify(teamAnalysisDb43Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb43Coverage = (0, team_analysis_db43_builder_1.buildDatabaseTeamAnalysisDb43Coverage)(teamAnalysisDb43Dataset);
    const teamAnalysisDb43Goldens = await (0, team_analysis_db43_golden_1.validateDatabaseTeamAnalysisDb43Goldens)(teamAnalysisDb43Dataset, teamAnalysisDb43Coverage);
    if (teamAnalysisDb43Goldens.failures.length > 0)
        throw new Error(`DB43 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb43Goldens.failures)}`);
    const teamAnalysisDb43Report = (0, team_analysis_db43_report_1.renderDatabaseTeamAnalysisDb43Report)(teamAnalysisDb43Dataset, teamAnalysisDb43Coverage);
    const singleStatProportionalEvidencePath = (0, path_1.resolve)(__dirname, "native-single-stat-energy-ball-proportional-semantics.json");
    const singleStatProportionalEvidenceBytes = await (0, promises_1.readFile)(singleStatProportionalEvidencePath);
    const singleStatProportionalEvidence = JSON.parse(singleStatProportionalEvidenceBytes.toString("utf8"));
    const singleStatProportionalEvidenceSha256 = sha256(singleStatProportionalEvidenceBytes);
    const buildTeamAnalysisDb44 = () => (0, team_analysis_db44_builder_1.buildDatabaseTeamAnalysisDb44Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: sha256(teamAnalysisDb8Gzip), db9: teamAnalysisDb9Dataset, db9Sha256: sha256(teamAnalysisDb9Gzip), db11: teamAnalysisDb11Dataset, db11Sha256: sha256(teamAnalysisDb11Gzip), db31: teamAnalysisDb31Dataset, db31Sha256: sha256(teamAnalysisDb31Gzip), db34: teamAnalysisDb34Dataset, db34Sha256: sha256(teamAnalysisDb34Gzip), db35: teamAnalysisDb35Dataset, db35Sha256: sha256(teamAnalysisDb35Gzip), db36: teamAnalysisDb36Dataset, db36Sha256: sha256(teamAnalysisDb36Gzip), db37: teamAnalysisDb37Dataset, db37Sha256: sha256(teamAnalysisDb37Gzip), db39: teamAnalysisDb39Dataset, db39Sha256: sha256(teamAnalysisDb39Gzip), tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: singleStatProportionalEvidence, evidenceSha256: singleStatProportionalEvidenceSha256 });
    const teamAnalysisDb44Dataset = buildTeamAnalysisDb44();
    const firstTeamAnalysisDb44Json = `${JSON.stringify(teamAnalysisDb44Dataset)}\n`;
    const secondTeamAnalysisDb44Json = `${JSON.stringify(buildTeamAnalysisDb44())}\n`;
    if (sha256(firstTeamAnalysisDb44Json) !== sha256(secondTeamAnalysisDb44Json))
        throw new Error("DB44 determinism check failed: two single-stat proportional projections differ");
    const teamAnalysisDb44Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb44Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb44Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb44Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb44Gzip.equals(secondTeamAnalysisDb44Gzip))
        throw new Error("DB44 determinism check failed: gzip bytes differ");
    const teamAnalysisDb44Validation = (0, team_analysis_db44_validator_1.validateDatabaseTeamAnalysisDb44Dataset)(teamAnalysisDb44Dataset, teamAnalysisDb11Dataset, teamAnalysisDb31Dataset, teamAnalysisDb35Dataset, teamAnalysisDb36Dataset, teamAnalysisDb37Dataset, tables, { db8Sha256: sha256(teamAnalysisDb8Gzip), db9Sha256: sha256(teamAnalysisDb9Gzip), db11Sha256: sha256(teamAnalysisDb11Gzip), db31Sha256: sha256(teamAnalysisDb31Gzip), db34Sha256: sha256(teamAnalysisDb34Gzip), db35Sha256: sha256(teamAnalysisDb35Gzip), db36Sha256: sha256(teamAnalysisDb36Gzip), db37Sha256: sha256(teamAnalysisDb37Gzip), db39Sha256: sha256(teamAnalysisDb39Gzip), db39NativeEvidenceSha256: proportionalStatEvidenceSha256, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: singleStatProportionalEvidence, evidenceSha256: singleStatProportionalEvidenceSha256 });
    if (!teamAnalysisDb44Validation.valid)
        throw new Error(`DB44 payload validation failed: ${JSON.stringify(teamAnalysisDb44Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb44Coverage = (0, team_analysis_db44_builder_1.buildDatabaseTeamAnalysisDb44Coverage)(teamAnalysisDb44Dataset);
    const teamAnalysisDb44Goldens = await (0, team_analysis_db44_golden_1.validateDatabaseTeamAnalysisDb44Goldens)(teamAnalysisDb44Dataset, teamAnalysisDb44Coverage);
    if (teamAnalysisDb44Goldens.failures.length > 0)
        throw new Error(`DB44 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb44Goldens.failures)}`);
    const teamAnalysisDb44Report = (0, team_analysis_db44_report_1.renderDatabaseTeamAnalysisDb44Report)(teamAnalysisDb44Dataset, teamAnalysisDb44Coverage);
    const postDamageHpFactorEvidencePath = (0, path_1.resolve)(__dirname, "native-player-attack-post-damage-hp-factor-semantics.json");
    const postDamageHpFactorEvidenceBytes = await (0, promises_1.readFile)(postDamageHpFactorEvidencePath);
    const postDamageHpFactorEvidence = JSON.parse(postDamageHpFactorEvidenceBytes.toString("utf8"));
    const postDamageHpFactorEvidenceSha256 = sha256(postDamageHpFactorEvidenceBytes);
    const db45SourceHashes = { db8: sha256(teamAnalysisDb8Gzip), db9: sha256(teamAnalysisDb9Gzip), db11: sha256(teamAnalysisDb11Gzip), db31: sha256(teamAnalysisDb31Gzip), db33: sha256(teamAnalysisDb33Gzip), db35: sha256(teamAnalysisDb35Gzip), db36: sha256(teamAnalysisDb36Gzip), db37: sha256(teamAnalysisDb37Gzip) };
    const buildTeamAnalysisDb45 = () => (0, team_analysis_db45_builder_1.buildDatabaseTeamAnalysisDb45Dataset)({ db8: teamAnalysisDb8Dataset, db8Sha256: db45SourceHashes.db8, db9: teamAnalysisDb9Dataset, db9Sha256: db45SourceHashes.db9, db11: teamAnalysisDb11Dataset, db11Sha256: db45SourceHashes.db11, db31: teamAnalysisDb31Dataset, db31Sha256: db45SourceHashes.db31, db33: teamAnalysisDb33Dataset, db33Sha256: db45SourceHashes.db33, db35: teamAnalysisDb35Dataset, db35Sha256: db45SourceHashes.db35, db36: teamAnalysisDb36Dataset, db36Sha256: db45SourceHashes.db36, db37: teamAnalysisDb37Dataset, db37Sha256: db45SourceHashes.db37, tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: postDamageHpFactorEvidence, evidenceSha256: postDamageHpFactorEvidenceSha256 });
    const teamAnalysisDb45Dataset = buildTeamAnalysisDb45();
    const firstTeamAnalysisDb45Json = `${JSON.stringify(teamAnalysisDb45Dataset)}\n`;
    const secondTeamAnalysisDb45Json = `${JSON.stringify(buildTeamAnalysisDb45())}\n`;
    if (sha256(firstTeamAnalysisDb45Json) !== sha256(secondTeamAnalysisDb45Json))
        throw new Error("DB45 determinism check failed: two post-damage HP-factor projections differ");
    const teamAnalysisDb45Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb45Json, "utf8"), { level: 9 });
    const secondTeamAnalysisDb45Gzip = (0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb45Json, "utf8"), { level: 9 });
    if (!teamAnalysisDb45Gzip.equals(secondTeamAnalysisDb45Gzip))
        throw new Error("DB45 determinism check failed: gzip bytes differ");
    const teamAnalysisDb45Validation = (0, team_analysis_db45_validator_1.validateDatabaseTeamAnalysisDb45Dataset)(teamAnalysisDb45Dataset, teamAnalysisDb11Dataset, teamAnalysisDb31Dataset, teamAnalysisDb33Dataset, teamAnalysisDb35Dataset, teamAnalysisDb36Dataset, teamAnalysisDb37Dataset, tables, { sourceHashes: db45SourceHashes, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: postDamageHpFactorEvidence, evidenceSha256: postDamageHpFactorEvidenceSha256 });
    if (!teamAnalysisDb45Validation.valid)
        throw new Error(`DB45 payload validation failed: ${JSON.stringify(teamAnalysisDb45Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb45Coverage = (0, team_analysis_db45_builder_1.buildDatabaseTeamAnalysisDb45Coverage)(teamAnalysisDb45Dataset);
    const teamAnalysisDb45Goldens = await (0, team_analysis_db45_golden_1.validateDatabaseTeamAnalysisDb45Goldens)(teamAnalysisDb45Dataset, teamAnalysisDb45Coverage);
    if (teamAnalysisDb45Goldens.failures.length > 0)
        throw new Error(`DB45 golden fixture validation failed: ${JSON.stringify(teamAnalysisDb45Goldens.failures)}`);
    const teamAnalysisDb45Report = (0, team_analysis_db45_report_1.renderDatabaseTeamAnalysisDb45Report)(teamAnalysisDb45Dataset, teamAnalysisDb45Coverage);
    const enemyAttackTimingEvidenceBytes = await (0, promises_1.readFile)((0, path_1.resolve)(__dirname, "native-enemy-attack-timing-semantics.json"));
    const enemyAttackTimingEvidence = JSON.parse(enemyAttackTimingEvidenceBytes.toString("utf8"));
    const enemyAttackTimingEvidenceSha256 = sha256(enemyAttackTimingEvidenceBytes);
    const buildTeamAnalysisDb46 = () => (0, team_analysis_db46_builder_1.buildDatabaseTeamAnalysisDb46Dataset)(teamAnalysisDb45Dataset, sha256(teamAnalysisDb45Gzip), nativeInspection, nativeBefore.sha256, nativeBefore.sizeBytes, enemyAttackTimingEvidence, enemyAttackTimingEvidenceSha256);
    const teamAnalysisDb46Dataset = buildTeamAnalysisDb46();
    const firstTeamAnalysisDb46Json = `${JSON.stringify(teamAnalysisDb46Dataset)}\n`;
    const secondTeamAnalysisDb46Json = `${JSON.stringify(buildTeamAnalysisDb46())}\n`;
    const teamAnalysisDb46Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb46Json, "utf8"), { level: 9 });
    if (sha256(firstTeamAnalysisDb46Json) !== sha256(secondTeamAnalysisDb46Json) || !teamAnalysisDb46Gzip.equals((0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb46Json, "utf8"), { level: 9 })))
        throw new Error("DB46 determinism check failed");
    const teamAnalysisDb46Validation = (0, team_analysis_db46_validator_1.validateDatabaseTeamAnalysisDb46Dataset)(teamAnalysisDb46Dataset, teamAnalysisDb45Dataset, nativeBefore.sha256, nativeBefore.sizeBytes, enemyAttackTimingEvidenceSha256);
    if (!teamAnalysisDb46Validation.valid)
        throw new Error(`DB46 payload validation failed: ${JSON.stringify(teamAnalysisDb46Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb46Coverage = (0, team_analysis_db46_builder_1.buildDatabaseTeamAnalysisDb46Coverage)(teamAnalysisDb46Dataset);
    const teamAnalysisDb46Goldens = (0, team_analysis_db46_golden_1.validateDatabaseTeamAnalysisDb46Goldens)(teamAnalysisDb46Dataset, teamAnalysisDb46Coverage);
    if (teamAnalysisDb46Goldens.failures.length)
        throw new Error(`DB46 goldens failed: ${JSON.stringify(teamAnalysisDb46Goldens.failures)}`);
    const teamAnalysisDb46Report = (0, team_analysis_db46_report_1.renderDatabaseTeamAnalysisDb46Report)(teamAnalysisDb46Coverage);
    const puzzleMoveEndEvidenceBytes = await (0, promises_1.readFile)((0, path_1.resolve)(__dirname, "native-puzzle-move-end-timing-semantics.json"));
    const puzzleMoveEndEvidence = JSON.parse(puzzleMoveEndEvidenceBytes.toString("utf8"));
    const puzzleMoveEndEvidenceSha256 = sha256(puzzleMoveEndEvidenceBytes);
    const buildTeamAnalysisDb47 = () => (0, team_analysis_db47_builder_1.buildDatabaseTeamAnalysisDb47Dataset)(teamAnalysisDb46Dataset, sha256(teamAnalysisDb46Gzip), nativeInspection, nativeBefore.sha256, nativeBefore.sizeBytes, puzzleMoveEndEvidence, puzzleMoveEndEvidenceSha256);
    const teamAnalysisDb47Dataset = buildTeamAnalysisDb47(), firstTeamAnalysisDb47Json = `${JSON.stringify(teamAnalysisDb47Dataset)}\n`, secondTeamAnalysisDb47Json = `${JSON.stringify(buildTeamAnalysisDb47())}\n`, teamAnalysisDb47Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb47Json, "utf8"), { level: 9 });
    if (sha256(firstTeamAnalysisDb47Json) !== sha256(secondTeamAnalysisDb47Json) || !teamAnalysisDb47Gzip.equals((0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb47Json, "utf8"), { level: 9 })))
        throw Error("DB47 determinism check failed");
    const teamAnalysisDb47Validation = (0, team_analysis_db47_validator_1.validateDatabaseTeamAnalysisDb47Dataset)(teamAnalysisDb47Dataset, teamAnalysisDb46Dataset, nativeBefore.sha256, nativeBefore.sizeBytes, puzzleMoveEndEvidenceSha256);
    if (!teamAnalysisDb47Validation.valid)
        throw Error(`DB47 validation failed: ${JSON.stringify(teamAnalysisDb47Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb47Coverage = (0, team_analysis_db47_builder_1.buildDatabaseTeamAnalysisDb47Coverage)(teamAnalysisDb47Dataset), teamAnalysisDb47Goldens = (0, team_analysis_db47_golden_1.validateDatabaseTeamAnalysisDb47Goldens)(teamAnalysisDb47Dataset, teamAnalysisDb47Coverage);
    if (teamAnalysisDb47Goldens.failures.length)
        throw Error(`DB47 goldens failed: ${JSON.stringify(teamAnalysisDb47Goldens.failures)}`);
    const teamAnalysisDb47Report = (0, team_analysis_db47_report_1.renderDatabaseTeamAnalysisDb47Report)(teamAnalysisDb47Coverage);
    const damageMitigationEvidenceBytes = await (0, promises_1.readFile)((0, path_1.resolve)(__dirname, "native-damage-mitigation-semantics.json"));
    const damageMitigationEvidence = JSON.parse(damageMitigationEvidenceBytes.toString("utf8")), damageMitigationEvidenceSha256 = sha256(damageMitigationEvidenceBytes), db48Hashes = { db11: sha256(teamAnalysisDb11Gzip), db35: sha256(teamAnalysisDb35Gzip), db36: sha256(teamAnalysisDb36Gzip), db37: sha256(teamAnalysisDb37Gzip), db47: sha256(teamAnalysisDb47Gzip) };
    const buildTeamAnalysisDb48 = () => (0, team_analysis_db48_builder_1.buildDatabaseTeamAnalysisDb48Dataset)({ db11: teamAnalysisDb11Dataset, db11Sha256: db48Hashes.db11, db35: teamAnalysisDb35Dataset, db35Sha256: db48Hashes.db35, db36: teamAnalysisDb36Dataset, db36Sha256: db48Hashes.db36, db37: teamAnalysisDb37Dataset, db37Sha256: db48Hashes.db37, db47: teamAnalysisDb47Dataset, db47Sha256: db48Hashes.db47, tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: damageMitigationEvidence, evidenceSha256: damageMitigationEvidenceSha256 });
    const teamAnalysisDb48Dataset = buildTeamAnalysisDb48(), firstTeamAnalysisDb48Json = `${JSON.stringify(teamAnalysisDb48Dataset)}\n`, secondTeamAnalysisDb48Json = `${JSON.stringify(buildTeamAnalysisDb48())}\n`, teamAnalysisDb48Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb48Json, "utf8"), { level: 9 });
    if (sha256(firstTeamAnalysisDb48Json) !== sha256(secondTeamAnalysisDb48Json) || !teamAnalysisDb48Gzip.equals((0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb48Json, "utf8"), { level: 9 })))
        throw Error("DB48 determinism check failed");
    const teamAnalysisDb48Validation = (0, team_analysis_db48_validator_1.validateDatabaseTeamAnalysisDb48Dataset)(teamAnalysisDb48Dataset, teamAnalysisDb11Dataset, teamAnalysisDb35Dataset, teamAnalysisDb36Dataset, teamAnalysisDb37Dataset, teamAnalysisDb47Dataset, tables, { db11Sha256: db48Hashes.db11, db35Sha256: db48Hashes.db35, db36Sha256: db48Hashes.db36, db37Sha256: db48Hashes.db37, db47Sha256: db48Hashes.db47, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidenceSha256: damageMitigationEvidenceSha256, proofRoles: damageMitigationEvidence.codeRegions.map(value => value.role) });
    if (!teamAnalysisDb48Validation.valid)
        throw Error(`DB48 validation failed: ${JSON.stringify(teamAnalysisDb48Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb48Coverage = (0, team_analysis_db48_builder_1.buildDatabaseTeamAnalysisDb48Coverage)(teamAnalysisDb48Dataset), teamAnalysisDb48Goldens = await (0, team_analysis_db48_golden_1.validateDatabaseTeamAnalysisDb48Goldens)(teamAnalysisDb48Dataset, teamAnalysisDb48Coverage);
    if (teamAnalysisDb48Goldens.failures.length)
        throw Error(`DB48 goldens failed: ${JSON.stringify(teamAnalysisDb48Goldens.failures)}`);
    const teamAnalysisDb48Report = (0, team_analysis_db48_report_1.renderDatabaseTeamAnalysisDb48Report)(teamAnalysisDb48Coverage);
    const forcedGuardEvidenceBytes = await (0, promises_1.readFile)((0, path_1.resolve)(__dirname, "native-forced-guard-semantics.json"));
    const forcedGuardEvidence = JSON.parse(forcedGuardEvidenceBytes.toString("utf8")), forcedGuardEvidenceSha256 = sha256(forcedGuardEvidenceBytes), db49Hashes = { db11: sha256(teamAnalysisDb11Gzip), db35: sha256(teamAnalysisDb35Gzip), db36: sha256(teamAnalysisDb36Gzip), db37: sha256(teamAnalysisDb37Gzip), db47: sha256(teamAnalysisDb47Gzip) };
    const buildTeamAnalysisDb49 = () => (0, team_analysis_db49_builder_1.buildDatabaseTeamAnalysisDb49Dataset)({ db11: teamAnalysisDb11Dataset, db11Sha256: db49Hashes.db11, db35: teamAnalysisDb35Dataset, db35Sha256: db49Hashes.db35, db36: teamAnalysisDb36Dataset, db36Sha256: db49Hashes.db36, db37: teamAnalysisDb37Dataset, db37Sha256: db49Hashes.db37, db47: teamAnalysisDb47Dataset, db47Sha256: db49Hashes.db47, tables, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: forcedGuardEvidence, evidenceSha256: forcedGuardEvidenceSha256 });
    const teamAnalysisDb49Dataset = buildTeamAnalysisDb49(), firstTeamAnalysisDb49Json = `${JSON.stringify(teamAnalysisDb49Dataset)}\n`, secondTeamAnalysisDb49Json = `${JSON.stringify(buildTeamAnalysisDb49())}\n`, teamAnalysisDb49Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb49Json, "utf8"), { level: 9 });
    if (sha256(firstTeamAnalysisDb49Json) !== sha256(secondTeamAnalysisDb49Json) || !teamAnalysisDb49Gzip.equals((0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb49Json, "utf8"), { level: 9 })))
        throw Error("DB49 determinism check failed");
    const teamAnalysisDb49Validation = (0, team_analysis_db49_validator_1.validateDatabaseTeamAnalysisDb49Dataset)(teamAnalysisDb49Dataset, teamAnalysisDb11Dataset, teamAnalysisDb35Dataset, teamAnalysisDb36Dataset, teamAnalysisDb37Dataset, teamAnalysisDb47Dataset, tables, { db11Sha256: db49Hashes.db11, db35Sha256: db49Hashes.db35, db36Sha256: db49Hashes.db36, db37Sha256: db49Hashes.db37, db47Sha256: db49Hashes.db47, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidenceSha256: forcedGuardEvidenceSha256, proofRoles: forcedGuardEvidence.codeRegions.map(value => value.role) });
    if (!teamAnalysisDb49Validation.valid)
        throw Error(`DB49 validation failed: ${JSON.stringify(teamAnalysisDb49Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb49Coverage = (0, team_analysis_db49_builder_1.buildDatabaseTeamAnalysisDb49Coverage)(teamAnalysisDb49Dataset), teamAnalysisDb49Goldens = await (0, team_analysis_db49_golden_1.validateDatabaseTeamAnalysisDb49Goldens)(teamAnalysisDb49Dataset, teamAnalysisDb49Coverage);
    if (teamAnalysisDb49Goldens.failures.length)
        throw Error(`DB49 goldens failed: ${JSON.stringify(teamAnalysisDb49Goldens.failures)}`);
    const teamAnalysisDb49Report = (0, team_analysis_db49_report_1.renderDatabaseTeamAnalysisDb49Report)(teamAnalysisDb49Coverage);
    const counterConsumerEvidenceBytes = await (0, promises_1.readFile)((0, path_1.resolve)(__dirname, "native-counter-consumer-semantics.json"));
    const counterConsumerEvidence = JSON.parse(counterConsumerEvidenceBytes.toString("utf8")), counterConsumerEvidenceSha256 = sha256(counterConsumerEvidenceBytes), db50Hashes = { db24: sha256(teamAnalysisDb24Gzip), db35: sha256(teamAnalysisDb35Gzip), db47: sha256(teamAnalysisDb47Gzip) };
    const buildTeamAnalysisDb50 = () => (0, team_analysis_db50_builder_1.buildDatabaseTeamAnalysisDb50Dataset)({ db24: teamAnalysisDb24Dataset, db24Sha256: db50Hashes.db24, db35: teamAnalysisDb35Dataset, db35Sha256: db50Hashes.db35, db47: teamAnalysisDb47Dataset, db47Sha256: db50Hashes.db47, inspection: nativeInspection, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidence: counterConsumerEvidence, evidenceSha256: counterConsumerEvidenceSha256 });
    const teamAnalysisDb50Dataset = buildTeamAnalysisDb50(), firstTeamAnalysisDb50Json = `${JSON.stringify(teamAnalysisDb50Dataset)}\n`, secondTeamAnalysisDb50Json = `${JSON.stringify(buildTeamAnalysisDb50())}\n`, teamAnalysisDb50Gzip = (0, zlib_1.gzipSync)(Buffer.from(firstTeamAnalysisDb50Json, "utf8"), { level: 9 });
    if (sha256(firstTeamAnalysisDb50Json) !== sha256(secondTeamAnalysisDb50Json) || !teamAnalysisDb50Gzip.equals((0, zlib_1.gzipSync)(Buffer.from(secondTeamAnalysisDb50Json, "utf8"), { level: 9 })))
        throw Error("DB50 determinism check failed");
    const teamAnalysisDb50Validation = (0, team_analysis_db50_validator_1.validateDatabaseTeamAnalysisDb50Dataset)(teamAnalysisDb50Dataset, teamAnalysisDb24Dataset, teamAnalysisDb35Dataset, teamAnalysisDb47Dataset, { db24Sha256: db50Hashes.db24, db35Sha256: db50Hashes.db35, db47Sha256: db50Hashes.db47, nativeSha256: nativeBefore.sha256, nativeSizeBytes: nativeBefore.sizeBytes, evidenceSha256: counterConsumerEvidenceSha256, proofRoles: counterConsumerEvidence.codeRegions.map(value => value.role) });
    if (!teamAnalysisDb50Validation.valid)
        throw Error(`DB50 validation failed: ${JSON.stringify(teamAnalysisDb50Validation.failures.slice(0, 10))}`);
    const teamAnalysisDb50Coverage = (0, team_analysis_db50_builder_1.buildDatabaseTeamAnalysisDb50Coverage)(teamAnalysisDb50Dataset), teamAnalysisDb50Goldens = await (0, team_analysis_db50_golden_1.validateDatabaseTeamAnalysisDb50Goldens)(teamAnalysisDb50Dataset, teamAnalysisDb50Coverage);
    if (teamAnalysisDb50Goldens.failures.length)
        throw Error(`DB50 goldens failed: ${JSON.stringify(teamAnalysisDb50Goldens.failures)}`);
    const teamAnalysisDb50Report = (0, team_analysis_db50_report_1.renderDatabaseTeamAnalysisDb50Report)(teamAnalysisDb50Coverage);
    ...
    await Promise.all([
        ...
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb29Manifest.fileName), teamAnalysisDb29Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db29-manifest.json"), `${JSON.stringify(teamAnalysisDb29Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb29Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb29Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb29Manifest.reportFile), teamAnalysisDb29Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb29Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb29Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb30Manifest.fileName), teamAnalysisDb30Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db30-manifest.json"), `${JSON.stringify(teamAnalysisDb30Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb30Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb30Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb30Manifest.reportFile), teamAnalysisDb30Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb30Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb30Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb31Manifest.fileName), teamAnalysisDb31Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db31-manifest.json"), `${JSON.stringify(teamAnalysisDb31Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb31Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb31Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb31Manifest.reportFile), teamAnalysisDb31Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb31Manifest.validationFile), `${JSON.stringify(teamAnalysisDb31Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb31Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb31Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb32Manifest.fileName), teamAnalysisDb32Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db32-manifest.json"), `${JSON.stringify(teamAnalysisDb32Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb32Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb32Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb32Manifest.reportFile), teamAnalysisDb32Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb32Manifest.validationFile), `${JSON.stringify(teamAnalysisDb32Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb32Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb32Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb33Manifest.fileName), teamAnalysisDb33Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db33-manifest.json"), `${JSON.stringify(teamAnalysisDb33Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb33Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb33Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb33Manifest.reportFile), teamAnalysisDb33Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb33Manifest.validationFile), `${JSON.stringify(teamAnalysisDb33Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb33Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb33Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb34Manifest.fileName), teamAnalysisDb34Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db34-manifest.json"), `${JSON.stringify(teamAnalysisDb34Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb34Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb34Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb34Manifest.reportFile), teamAnalysisDb34Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb34Manifest.validationFile), `${JSON.stringify(teamAnalysisDb34Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb34Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb34Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb35Manifest.fileName), teamAnalysisDb35Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db35-manifest.json"), `${JSON.stringify(teamAnalysisDb35Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb35Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb35Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb35Manifest.reportFile), teamAnalysisDb35Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb35Manifest.validationFile), `${JSON.stringify(teamAnalysisDb35Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb35Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb35Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb36Manifest.fileName), teamAnalysisDb36Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db36-manifest.json"), `${JSON.stringify(teamAnalysisDb36Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb36Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb36Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb36Manifest.reportFile), teamAnalysisDb36Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb36Manifest.validationFile), `${JSON.stringify(teamAnalysisDb36Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb36Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb36Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb37Manifest.fileName), teamAnalysisDb37Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db37-manifest.json"), `${JSON.stringify(teamAnalysisDb37Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb37Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb37Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb37Manifest.reportFile), teamAnalysisDb37Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb37Manifest.validationFile), `${JSON.stringify(teamAnalysisDb37Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb37Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb37Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb38Manifest.fileName), teamAnalysisDb38Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db38-manifest.json"), `${JSON.stringify(teamAnalysisDb38Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb38Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb38Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb38Manifest.reportFile), teamAnalysisDb38Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb38Manifest.validationFile), `${JSON.stringify(teamAnalysisDb38Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb38Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb38Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb39Manifest.fileName), teamAnalysisDb39Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db39-manifest.json"), `${JSON.stringify(teamAnalysisDb39Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb39Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb39Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb39Manifest.reportFile), teamAnalysisDb39Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb39Manifest.validationFile), `${JSON.stringify(teamAnalysisDb39Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb39Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb39Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb40Manifest.fileName), teamAnalysisDb40Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db40-manifest.json"), `${JSON.stringify(teamAnalysisDb40Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb40Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb40Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb40Manifest.reportFile), teamAnalysisDb40Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb40Manifest.validationFile), `${JSON.stringify(teamAnalysisDb40Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb40Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb40Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb41Manifest.fileName), teamAnalysisDb41Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db41-manifest.json"), `${JSON.stringify(teamAnalysisDb41Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb41Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb41Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb41Manifest.reportFile), teamAnalysisDb41Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb41Manifest.validationFile), `${JSON.stringify(teamAnalysisDb41Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb41Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb41Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb42Manifest.fileName), teamAnalysisDb42Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db42-manifest.json"), `${JSON.stringify(teamAnalysisDb42Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb42Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb42Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb42Manifest.reportFile), teamAnalysisDb42Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb42Manifest.validationFile), `${JSON.stringify(teamAnalysisDb42Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb42Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb42Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb43Manifest.fileName), teamAnalysisDb43Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db43-manifest.json"), `${JSON.stringify(teamAnalysisDb43Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb43Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb43Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb43Manifest.reportFile), teamAnalysisDb43Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb43Manifest.validationFile), `${JSON.stringify(teamAnalysisDb43Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb43Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb43Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb44Manifest.fileName), teamAnalysisDb44Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db44-manifest.json"), `${JSON.stringify(teamAnalysisDb44Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb44Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb44Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb44Manifest.reportFile), teamAnalysisDb44Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb44Manifest.validationFile), `${JSON.stringify(teamAnalysisDb44Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb44Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb44Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb45Manifest.fileName), teamAnalysisDb45Gzip),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db45-manifest.json"), `${JSON.stringify(teamAnalysisDb45Manifest, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb45Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb45Coverage, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb45Manifest.reportFile), teamAnalysisDb45Report, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb45Manifest.validationFile), `${JSON.stringify(teamAnalysisDb45Validation, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb45Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb45Goldens, null, 2)}\n`, "utf8"),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb46Manifest.fileName), teamAnalysisDb46Gzip), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db46-manifest.json"), `${JSON.stringify(teamAnalysisDb46Manifest, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb46Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb46Coverage, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb46Manifest.reportFile), teamAnalysisDb46Report), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb46Manifest.validationFile), `${JSON.stringify(teamAnalysisDb46Validation, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb46Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb46Goldens, null, 2)}\n`),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb47Manifest.fileName), teamAnalysisDb47Gzip), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db47-manifest.json"), `${JSON.stringify(teamAnalysisDb47Manifest, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb47Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb47Coverage, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb47Manifest.reportFile), teamAnalysisDb47Report), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb47Manifest.validationFile), `${JSON.stringify(teamAnalysisDb47Validation, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb47Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb47Goldens, null, 2)}\n`),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb48Manifest.fileName), teamAnalysisDb48Gzip), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db48-manifest.json"), `${JSON.stringify(teamAnalysisDb48Manifest, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb48Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb48Coverage, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb48Manifest.reportFile), teamAnalysisDb48Report), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb48Manifest.validationFile), `${JSON.stringify(teamAnalysisDb48Validation, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb48Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb48Goldens, null, 2)}\n`),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb49Manifest.fileName), teamAnalysisDb49Gzip), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db49-manifest.json"), `${JSON.stringify(teamAnalysisDb49Manifest, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb49Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb49Coverage, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb49Manifest.reportFile), teamAnalysisDb49Report), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb49Manifest.validationFile), `${JSON.stringify(teamAnalysisDb49Validation, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb49Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb49Goldens, null, 2)}\n`),
        (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb50Manifest.fileName), teamAnalysisDb50Gzip), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, "team-analysis-db50-manifest.json"), `${JSON.stringify(teamAnalysisDb50Manifest, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb50Manifest.coverageFile), `${JSON.stringify(teamAnalysisDb50Coverage, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb50Manifest.reportFile), teamAnalysisDb50Report), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb50Manifest.validationFile), `${JSON.stringify(teamAnalysisDb50Validation, null, 2)}\n`), (0, promises_1.writeFile)((0, path_1.resolve)(options.outputDir, teamAnalysisDb50Manifest.goldenValidationFile), `${JSON.stringify(teamAnalysisDb50Goldens, null, 2)}\n`),
    ]);
    return { manifest, sourceManifest, teamAnalysisManifest, teamAnalysisDb3Manifest, teamAnalysisDb4Manifest, teamAnalysisDb5Manifest, teamAnalysisDb6Manifest, teamAnalysisDb7Manifest, teamAnalysisDb8Manifest, teamAnalysisDb9Manifest, teamAnalysisDb10Manifest, teamAnalysisDb11Manifest, teamAnalysisDb12Manifest, teamAnalysisDb13Manifest, teamAnalysisDb14Manifest, teamAnalysisDb15Manifest, teamAnalysisDb16Manifest, teamAnalysisDb17Manifest, teamAnalysisDb18Manifest, teamAnalysisDb19Manifest, teamAnalysisDb20Manifest, teamAnalysisDb21Manifest, teamAnalysisDb22Manifest, teamAnalysisDb23Manifest, teamAnalysisDb24Manifest, teamAnalysisDb25Manifest, teamAnalysisDb26Manifest, teamAnalysisDb27Manifest, teamAnalysisDb28Manifest, teamAnalysisDb29Manifest, teamAnalysisDb30Manifest, teamAnalysisDb31Manifest, teamAnalysisDb32Manifest, teamAnalysisDb33Manifest, teamAnalysisDb34Manifest, teamAnalysisDb35Manifest, teamAnalysisDb36Manifest, teamAnalysisDb37Manifest, teamAnalysisDb38Manifest, teamAnalysisDb39Manifest, teamAnalysisDb40Manifest, teamAnalysisDb41Manifest, teamAnalysisDb42Manifest, teamAnalysisDb43Manifest, teamAnalysisDb44Manifest, teamAnalysisDb45Manifest, teamAnalysisDb46Manifest, teamAnalysisDb47Manifest, teamAnalysisDb48Manifest, teamAnalysisDb49Manifest, teamAnalysisDb50Manifest, outputDir: options.outputDir, deterministicRebuildSha256: sha256(secondGzip) };
}
...
async function main() {
    ...
    console.log(JSON.stringify({
        ...
        teamAnalysisDb44Artifact: result.teamAnalysisDb44Manifest,
        teamAnalysisDb45Artifact: result.teamAnalysisDb45Manifest,
        teamAnalysisDb46Artifact: result.teamAnalysisDb46Manifest,
        teamAnalysisDb47Artifact: result.teamAnalysisDb47Manifest,
        teamAnalysisDb48Artifact: result.teamAnalysisDb48Manifest,
        teamAnalysisDb49Artifact: result.teamAnalysisDb49Manifest,
        teamAnalysisDb50Artifact: result.teamAnalysisDb50Manifest,
