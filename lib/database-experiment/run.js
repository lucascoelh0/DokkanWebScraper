...
async function runDatabaseExperiment(options) {
    ...
    const attackBreakEvidencePath = (0, path_1.resolve)(__dirname, "..", "..", "database-experiment", "native-attack-break-semantics.json");
    ...
    const removalEvidencePath = (0, path_1.resolve)(__dirname, "..", "..", "database-experiment", "native-efficacy-removal-semantics.json");
