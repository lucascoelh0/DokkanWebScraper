...
exports.renderDatabaseTeamAnalysisDb43Report = void 0;
const rows = (values) => Object.entries(values).map(([value, count]) => `| ${value} | ${count} |`).join("\n");
function renderDatabaseTeamAnalysisDb43Report(dataset, coverage) {
...
exports.renderDatabaseTeamAnalysisDb43Report = renderDatabaseTeamAnalysisDb43Report;
//# sourceMappingURL=team-analysis-db43-report.js.map