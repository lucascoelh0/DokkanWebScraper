...
exports.TEAM_ANALYSIS_PARSER_VERSION = "1.9.15";
...
function buildTeamAnalysisDataset(characters, catalogEntries, options) {
    ...
    const states = characters
        .flatMap(character => buildCharacterStates(character, catalogById.get(character.id), options.nameIdentityContract, options.cardIdentityContract, options.activeSkillActivationContract))
...
function buildCharacterStates(character, catalogEntry, nameIdentityContract, cardIdentityContract, activeSkillActivationContract) {
