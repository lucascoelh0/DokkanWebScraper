...
exports.TEAM_ANALYSIS_PARSER_VERSION = "1.4.0";
...
function parseEnemyStatusValues(sourceText, selection, predicateSourceText) {
    ...
    const children = matches.map(match => enemyStatusPredicate(parseEnemyStatusTerm(match[0]), selection, predicateSourceText));
