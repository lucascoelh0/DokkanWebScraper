...
exports.TEAM_ANALYSIS_PARSER_VERSION = "1.5.0";
...
function parseEffects(sourceText, context) {
    ...
    const effects = parsedAtoms.atoms.map(atom => applyEffectTarget(context.kiSphereScaling && atom.kind !== "ki_sphere_change" && !atom.scaling
