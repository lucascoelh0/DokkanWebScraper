...
exports.TEAM_ANALYSIS_PARSER_VERSION = "1.5.1";
...
function parseEffects(sourceText, context) {
    ...
    const effects = parsedAtoms.atoms.map(atom => enrichCalculationPhase(applyEffectTarget(context.kiSphereScaling && atom.kind !== "ki_sphere_change" && !atom.scaling
...
function enrichCalculationPhase(effect, effectSourceText, context) {
    ...
    return {
        ...effect,
        activationTiming,
        calculationBucket: resolveCalculationBucket(effectSourceText, context.phaseContextText, context.kiSphereScaling),
    };
}
...
function domainActivationMoment(phaseContextText, kiSphereScaling) {
...
function resolveCalculationBucket(effectSourceText, phaseContextText, kiSphereScaling) {
