...
window.__ITEMS_DATA__ = items;
        ...
        const skins = (0, dokkanstats_frontier_1.parseDokkanStatsCardSkins)(html);
...
<div class="mission-card-square">
  ...
  <div class="mission-dates">
    ...
    <span class="date-item date-item-end"><span class="date-label">End</span><span class="date-chip">No Expiry</span></span>
        ...
        const category = (0, dokkanstats_frontier_1.parseDokkanStatsMissionCategory)(html, "200101");
    ...
    it("fails closed when the advertised mission count differs from the rendered cards", () => {
        assert.throws(() => (0, dokkanstats_frontier_1.parseDokkanStatsMissionCategory)("<html><body>2 missions</body></html>", "200101"), /advertised 2 missions but exposed 0/);
    });
    it("builds deterministic source ordering and counts", () => {
        const dataset = (0, dokkanstats_frontier_1.buildDokkanStatsFrontierDataset)([{
                id: "75",
                cardId: "1028721",
                step: 3,
...
//# sourceMappingURL=dokkanstats-frontier.spec.js.map