...
(0, mocha_1.describe)("Team Analysis R2 delivery gate", function () {
    ...
    (0, mocha_1.it)("publishes staging payload and manifest only under staging keys", async () => {
        ...
        const stagingPayloadKey = (0, publish_team_analysis_r2_1.buildTeamAnalysisDatasetObjectKey)(fixture.artifact.manifest, "staging");
        const stagingManifestKey = (0, publish_team_analysis_r2_1.buildTeamAnalysisManifestObjectKey)("staging");
    ...
    (0, mocha_1.it)("uses conservative defaults and rejects conflicting targets or unsafe flags", () => {
        ...
        const staging = (0, publish_team_analysis_r2_1.parseTeamAnalysisR2PublishArgs)(["--channel", "staging"]);
        (0, assert_1.equal)(staging.channel, "staging");
        (0, assert_1.equal)(staging.manifestObjectKey, "staging/team-analysis-manifest.json");
        (0, assert_1.equal)(staging.statePath.endsWith("team-analysis-r2-publish-state-staging.json"), true);
        ...
        (0, assert_1.rejects)(async () => (0, publish_team_analysis_r2_1.parseTeamAnalysisR2PublishArgs)(["--channel", "preview"]), /Invalid dataset publication channel/);
