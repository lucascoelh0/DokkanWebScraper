...
(0, mocha_1.describe)("buildFallbackCategoryEntry", function () {
    (0, mocha_1.it)("reuses existing members and augments them with current leaders and support units", () => {
        const category = (0, fyi_categories_1.buildFallbackCategoryEntry)({
            id: 80,
            name: "Accelerated Battle",
            characters: {
                leaders: [
        ...
        (0, assert_1.deepEqual)(category.members?.map(member => member.id), ["1029021", "1025511", "1033551"]);
    });
});
