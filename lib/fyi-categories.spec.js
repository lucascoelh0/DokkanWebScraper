...
(0, mocha_1.describe)("mergeCategorySupportFromSupportOnly", function () {
    (0, mocha_1.it)("replaces the support list with the dedicated support-only surface", () => {
        const category = (0, fyi_categories_1.mergeCategorySupportFromSupportOnly)({
            id: "21",
            name: "Androids",
            leaders: [],
            support: [
        ...
        (0, assert_1.deepEqual)(category.support.map(character => character.id), ["1017681", "1023361"]);
    });
});
