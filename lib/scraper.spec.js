...
describe("Multitransform Art URL Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Max Level - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.artURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/5/5e/Card_1014760_artwork.png/revision/latest?cb=20230124190253");
    });
});
describe("LR Art URL Extraction", function () {
    (0, mocha_1.it)("should be able to extract the LR Art", () => {
        (0, assert_1.equal)(standardCharacterData.artURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/8/8a/Card_1020220_artwork_apng.webp/revision/latest?cb=20210802101948");
    });
});
describe("Transformed Art URL Extraction Multi Transformation", function () {
    (0, mocha_1.it)("should be able to extract the Multi Transformation Art", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].artURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/a/ac/Card_4014780_artwork.png/revision/latest?cb=20230124190256");
    });
});
describe("LR Art URL Extraction Transformation", function () {
    (0, mocha_1.it)("should be able to extract the LR Transformation Art", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].artURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/4/41/Card_4022390_artwork_apng.webp/revision/latest?cb=20220131111841");
    });
});
...
describe("Class Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Class - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.characterClass, "Super");
    });
    (0, mocha_1.it)("should be able to extract the Class - transform", () => {
        (0, assert_1.equal)(transformCharacterData.characterClass, "Super");
    });
    (0, mocha_1.it)("should be able to extract the Class - EZA", () => {
        (0, assert_1.equal)(EZAActiveCharacterData.characterClass, "Super");
    });
    (0, mocha_1.it)("should be able to extract the Class - standard", () => {
        (0, assert_1.equal)(standardCharacterData.characterClass, "Super");
    });
});
...
describe("portraitURL Extraction", function () {
    (0, mocha_1.it)("should be able to extract the portraitURL - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.portraitURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/2/23/Card_1014760_thumb.png/revision/latest?cb=20180827182222");
    });
    (0, mocha_1.it)("should be able to extract the transformedportraitURL - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].portraitURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/4/49/Card_4014770_thumb.png/revision/latest?cb=20181017022011");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].portraitURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/0/01/Card_4014780_thumb.png/revision/latest?cb=20181017022642");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].portraitURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/5/56/Card_4014790_thumb.png/revision/latest?cb=20181017022642");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].portraitURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/5/55/Card_4014800_thumb.png/revision/latest?cb=20181017022642");
    });
    (0, mocha_1.it)("should be able to extract the portraitURL - transform", () => {
        (0, assert_1.equal)(transformCharacterData.portraitURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/7/75/Card_1022380_thumb_apng.png/revision/latest?cb=20220130071219&format=original");
    });
    (0, mocha_1.it)("should be able to extract the transformedportraitURL - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].portraitURL, "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/b/b4/Card_4022390_thumb_apng.png/revision/latest?cb=20220130071254&format=original");
    });
    (0, mocha_1.it)("should be able to extract the portraitURL - EZA", () => {
        (0, assert_1.equal)(EZAActiveCharacterData.portraitURL, "https://vignette.wikia.nocookie.net/dbz-dokkanbattle/images/3/35/Card_1015910_thumb_apng.png/revision/latest?cb=20190128070309&format=original");
    });
    (0, mocha_1.it)("should be able to extract the portraitURL - standard", () => {
        (0, assert_1.equal)(standardCharacterData.portraitURL, "https://vignette.wikia.nocookie.net/dbz-dokkanbattle/images/a/a1/Card_1020220_thumb_apng.png/revision/latest?cb=20200916113202&format=original");
    });
});
...
describe("Categories Extraction", function () {
    ...
    (0, mocha_1.it)("should be able to extract the Categories - EZA", () => {
        (0, assert_1.deepEqual)(EZAActiveCharacterData.categories, ['Hybrid Saiyans', 'Dragon Ball Seekers', "Goku's Family", 'Youth', 'Space-Traveling Warriors', 'GT Heroes', 'Bond of Friendship', 'Bond of Parent and Child', 'Earth-Bred Fighters']);
    });
...
describe("Tranformation Names Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation Names - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].name, 'Super Saiyan 2 Goku');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].name, 'Super Saiyan 3 Goku');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].name, 'Super Saiyan God Goku');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].name, 'Super Saiyan God SS Goku');
    });
    (0, mocha_1.it)("should be able to extract the Transformations Names - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].name, 'Super Saiyan God SS Goku & Super Saiyan God SS Vegeta');
    });
});
describe("Tranformation TransformedID Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedID - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].id, '41477');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].id, '41478');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].id, '41479');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].id, '41480');
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedID - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].id, '42239');
    });
});
describe("Tranformation TransformedClass Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedClass - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].characterClass, 'Super');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].characterClass, 'Super');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].characterClass, 'Super');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].characterClass, 'Super');
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedClass - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].characterClass, 'Super');
    });
});
describe("Tranformation TransformedType Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedType - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].type, 'AGL');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].type, 'AGL');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].type, 'AGL');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].type, 'AGL');
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedType - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].type, 'TEQ');
    });
});
describe("Tranformation TransformedSuperAttack Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedSuperAttack - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].superAttack, 'Raises ATK & DEF[1] and causes immense damage to enemy');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].superAttack, 'Raises ATK & DEF[1] and causes immense damage to enemy');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].superAttack, 'Raises ATK & DEF[1] and causes immense damage to enemy');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].superAttack, 'Causes immense damage with a great chance to stun the enemy[1]');
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedSuperAttack - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].superAttack, 'Greatly raises ATK & DEF for 1 turn[1] and causes colossal damage to enemy');
    });
});
describe("Tranformation TransformedEZASuperAttack Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedEZASuperAttack - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].ezaSuperAttack, 'Raises ATK & DEF[1], causes immense damage to enemy and lowers DEF[2]');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].ezaSuperAttack, 'Raises ATK & DEF[1], causes immense damage to enemy and lowers DEF[2]');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].ezaSuperAttack, 'Raises ATK & DEF[1], causes immense damage to enemy and lowers DEF[2]');
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].ezaSuperAttack, 'Raises ATK & DEF for 1 turn[2] and causes immense damage with a great chance of stunning the enemy[1]');
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedEZASuperAttack - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].ezaSuperAttack, undefined);
    });
});
describe("Tranformation TransformedUltraSuperAttack Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedUltraSuperAttack - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].ultraSuperAttack, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].ultraSuperAttack, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].ultraSuperAttack, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].ultraSuperAttack, undefined);
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedUltraSuperAttack - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].ultraSuperAttack, "Massively raises ATK & DEF for 1 turn[2] and causes mega-colossal damage to enemy; disables enemy's action once within the turn");
    });
});
describe("Tranformation TransformedUltraSuperAttack Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedUltraSuperAttack - multitransform", () => {
...
describe("Tranformation TransformedEZAUltraSuperAttack Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformations TransformedEZAUltraSuperAttack - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].ezaUltraSuperAttack, undefined);
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedEZAUltraSuperAttack - transform", () => {
        (0, assert_1.equal)(transformEZALRCharacterData.transformations[0].ezaUltraSuperAttack, "Greatly raises DEF for 1 turn[3], causes mega-colossal damage to enemy and greatly lowers ATK & DEF[4]");
    });
});
describe("Tranformation TransformedPassive Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedPassive - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].passive, "ATK +90% and DEF +60%; reduces damage received by 22%; Transform when conditions are met");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].passive, "ATK +100% and DEF +40%; reduces damage received by 23%; Transform when conditions are met");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].passive, "ATK +110% and DEF +20%; reduces damage received by 24%; Transform when conditions are met");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].passive, "ATK +120%; reduces damage received by 25%; Ki +12 and performs a critical hit (once only)");
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedPassive - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].passive, "ATK & DEF +177%; plus an additional Ki +2 per Type Ki Sphere obtained; chance of performing a critical hit and chance of evading enemy's attack (including Super Attack) +7% per  Ki Sphere obtained; attacks effective against all types when Ki is 16 or more; launches an additional Super Attack when Ki is 20 or more; medium chance[3] of performing a critical hit; medium chance[4] of evading enemy's attack (including Super Attack)");
    });
});
describe("Tranformation TransformedEZAPassive Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedEZAPassive - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].ezaPassive, "ATK & DEF +120%; Ki +3 plus an additional ATK +20% and DEF +30% when attacking Extreme Class enemies; reduces damage received by 22%; Transforms when conditions are met");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].ezaPassive, "ATK & DEF +130%; Ki +3 plus an additional ATK +30% and DEF +20% when attacking Extreme Class enemies; reduces damage received by 23%; Transforms when conditions are met");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].ezaPassive, "ATK & DEF +140%; Ki +3 plus an additional ATK +40% and DEF +10% when attacking Extreme Class enemies; reduces damage received by 24%; Transforms when conditions are met");
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].ezaPassive, "ATK & DEF +150%; Ki +3 plus an additional ATK +50% when attacking Extreme Class enemies; reduces damage received by 25%; Ki +12 and performs a critical hit (once only)");
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedEZAPassive - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].ezaPassive, undefined);
    });
});
describe("Tranformation TransformedActiveSkill Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedActiveSkill - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].activeSkill, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].activeSkill, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].activeSkill, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].activeSkill, undefined);
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedActiveSkill - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].activeSkill, "Causes ultimate damage to enemy and, within the turn activated, all attacks become critical hits");
    });
});
describe("Tranformation TransformedActiveSkillCondition Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedActiveSkillCondition - multitransform", () => {
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[0].activeSkillCondition, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[1].activeSkillCondition, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[2].activeSkillCondition, undefined);
        (0, assert_1.equal)(multiTransformEZACharacterData.transformations[3].activeSkillCondition, undefined);
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedActiveSkillCondition - transform", () => {
        (0, assert_1.equal)(transformCharacterData.transformations[0].activeSkillCondition, "Can be activated when HP is 50% or less or when facing only 1 enemy, whose HP is 50% or less (once only)");
    });
});
...
describe("Tranformation TransformedLinks Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedLinks - multitransform", () => {
        (0, assert_1.deepEqual)(multiTransformEZACharacterData.transformations[0].links, ['All in the Family', 'Golden Warrior', 'Super Saiyan', 'Experienced Fighters', 'Kamehameha', 'Prepared for Battle', 'Fierce Battle']);
        (0, assert_1.deepEqual)(multiTransformEZACharacterData.transformations[1].links, ['Limit-Breaking Form', 'Golden Warrior', 'Super Saiyan', 'Experienced Fighters', 'Kamehameha', 'Over in a Flash', 'Fierce Battle']);
        (0, assert_1.deepEqual)(multiTransformEZACharacterData.transformations[2].links, ['Godly Power', 'Warrior Gods', 'Super Saiyan', 'Shocking Speed', 'All in the Family', 'Over in a Flash', 'Fierce Battle']);
        (0, assert_1.deepEqual)(multiTransformEZACharacterData.transformations[3].links, ['Godly Power', 'Warrior Gods', 'Super Saiyan', 'Shocking Speed', 'All in the Family', 'Over in a Flash', 'Fierce Battle']);
    });
    (0, mocha_1.it)("should be able to extract the Transformations TransformedLinks - transform", () => {
        (0, assert_1.deepEqual)(transformCharacterData.transformations[0].links, ['Super Saiyan', 'Kamehameha', 'Warrior Gods', 'Godly Power', 'Prepared for Battle', 'Fierce Battle', 'Legendary Power']);
    });
});
describe("Tranformation TransformedLinks Extraction", function () {
    (0, mocha_1.it)("should be able to extract the Transformation TransformedLinks - multitransform", () => {
