...
(0, mocha_1.describe)("parseLeaderSkillDetails", function () {
    (0, mocha_1.it)("shares Mamba's trailing Ki and stat boost across category and type alternatives", () => {
        const details = (0, scraper_1.parseLeaderSkillDetails)(`"Peppy Gals" Category or Extreme AGL Type Ki +3 and HP, ATK & DEF +140%`);
        (0, assert_1.equal)(details?.displayBoost, 140);
    ...
    (0, mocha_1.it)("does not share a suffix across a semicolon-or alternative", () => {
        const details = (0, scraper_1.parseLeaderSkillDetails)(`"A" Category Ki +3; or "B" Category Ki +2 and HP, ATK & DEF +170%`);
        (0, assert_1.deepEqual)(details?.clauses.map(clause => ({
    ...
    (0, mocha_1.it)("does not replace a partial local boost with a plain-or suffix", () => {
        const details = (0, scraper_1.parseLeaderSkillDetails)(`"A" Category ATK +100% or Extreme AGL Type Ki +3 and HP, ATK & DEF +140%`);
        (0, assert_1.deepEqual)(details?.clauses.map(clause => ({
            categories: clause.categories,
            types: clause.types,
            ki: clause.ki,
    ...
    (0, mocha_1.it)("keeps Panzy's 170 percent base plus 50 percent additional path", () => {
        const details = (0, scraper_1.parseLeaderSkillDetails)(`"Demonic Power" or "DAIMA" Category Ki +3 and HP, ATK & DEF +170%, plus an additional HP, ATK & DEF +50% for characters who also belong to the "Battle of Wits", "Realm of Gods" or "Pure Saiyans" Category`);
        (0, assert_1.equal)(details?.displayBoost, 220);
        (0, assert_1.deepEqual)(details?.clauses.map(clause => ({
    ...
    (0, mocha_1.it)("keeps Glorio exclusions separate from the qualifying additional category", () => {
        const details = (0, scraper_1.parseLeaderSkillDetails)(`"Demonic Power" Category Ki +3 and HP, ATK & DEF +200%; "Battle of Wits" or "Accelerated Battle" Category Ki +3 and HP, ATK & DEF +170%, plus an additional HP, ATK & DEF +30% for characters who also belong to the "Dragon Ball Seekers" Category ("Demonic Power" Category characters excluded)`);
        (0, assert_1.equal)(details?.displayBoost, 200);
        (0, assert_1.deepEqual)(details?.clauses.map(clause => ({
            stackGroup: clause.stackGroup,
            categories: clause.categories,
    ...
    (0, mocha_1.it)("does not carry a percentage path across a flat alternative", () => {
        const details = (0, scraper_1.parseLeaderSkillDetails)(`"Powerful Comeback" Category HP, ATK & DEF +170%; All Types ATK +2500; plus an additional HP, ATK & DEF +30% for characters who also belong to the "Battle of Fate" Category`);
        (0, assert_1.equal)(details?.displayBoost, 170);
        (0, assert_1.deepEqual)(details?.clauses.map(clause => ({
            stackGroup: clause.stackGroup,
    ...
    (0, mocha_1.it)("labels mixed HP and ATK DEF leaders by their combat boost", () => {
    ...
    (0, mocha_1.it)("does not add an HP-only clause to an ATK and DEF display ceiling", () => {
        const details = (0, scraper_1.parseLeaderSkillDetails)(`"Example" Category HP +200% and ATK & DEF +170%, plus an additional HP +30% for characters who also belong to the "Second" Category`);
        (0, assert_1.equal)(details?.displayBoost, 170);
        (0, assert_1.deepEqual)(details?.clauses.map(clause => ({
            stackGroup: clause.stackGroup,
            hp: clause.hp,
