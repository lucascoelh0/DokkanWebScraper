...
import { WT6_ALLOWED_HISTORICAL_HAR_TARGET_FINGERPRINTS, Wt6Dataset, Wt6Decision, Wt6MemoryEvidence, Wt6Validation } from "./wt6-contract";
...
export function buildWt6(source: Wt6Dataset["source"], lineage: Wt6Dataset["lineage"], aggregateSha256: string, implementationAggregateSha256: string, scan: Wt6Dataset["security"], memory: Wt6MemoryEvidence): Wt6Dataset {
    ...
    const dataset: Wt6Dataset = {
        schemaVersion: 1, contract: "dokkan-world-tournament-readiness", contractVersion: "0.8.0", collectionMode: "offline_double_generation_no_requests", productionMutation: false, defaultEnabled: false, source, lineage, determinism: { passCount: 2, upstreamArtifactCount: 18, wt6OutputFileCount: 3, totalArtifactCount: 21, upstreamAggregateSha256: aggregateSha256, implementationAggregateSha256, upstreamByteIdentical: true, wt6OutputByteIdentical: true }, security: scan, memory, decisions,
...
export function validateWt6(dataset: Wt6Dataset): Wt6Validation {
    ...
    if (dataset.schemaVersion !== 1 || dataset.contract !== "dokkan-world-tournament-readiness" || dataset.contractVersion !== "0.8.0" || dataset.collectionMode !== "offline_double_generation_no_requests" || dataset.productionMutation || dataset.defaultEnabled) failures.push("contract");
    ...
    if (dataset.stop.gate !== "WT6" || dataset.stop.executionIntegrationPerformed || dataset.stop.integrationPolicy !== "reviewed_offline_default_off_infrastructure_only") failures.push("stop boundary");
