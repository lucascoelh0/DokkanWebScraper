...
import { scanWtCampaignTexts } from "./wt0-audit";
...
describe("world tournament WT6", () => {
    ...
    it("rejects false determinism and merge permission", () => { const value = dataset(); value.determinism.upstreamAggregateSha256 = "b".repeat(64); value.stop.mergeMainAllowed = true as false; assert.equal(validateWt6(value).valid, false); });
