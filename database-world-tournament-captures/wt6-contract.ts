...
export interface Wt6MemoryEvidence { schemaVersion: 1; contract: "dokkan-world-tournament-memory-evidence"; contractVersion: "0.10.0"; method: "windows_process_tree_working_set_poll_15ms"; limitBytes: 1073741824; sourceSha256: string; artifactAggregateSha256: string; implementationAggregateSha256: string; measurements: Array<{ gate: "WT0" | "WT1" | "WT2" | "WT3" | "WT4" | "WT5" | "WT6"; peakProcessTreeWorkingSetBytes: number; exitCode: 0 }>; observedMaxPeakBytes: number }
