...
export async function runEventsSqliteBridge<T>(command: "inventory" | "catalog" | "topology" | "encounters" | "mechanics" | "rewards" | "assets", databasePath: string, onData?: () => void): Promise<T> {
